...
The GUI does not display the sysctls that are pre-set when FreeNAS® is installed. FreeNAS® 9.3.2 ships with the following sysctls set::
...
The GUI does not display the loaders that are pre-set when FreeNAS® is installed. FreeNAS® 9.3.2 ships with the following loaders set::
