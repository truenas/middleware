...
As seen in Figure 18.1a, an online version of the API is available at `api.freenas.org <http://api.freenas.org>`_.

**Figure 18.1a: FreeNAS® API Documentation**
...
values that you input must be valid for a FreeBSD user account. Table 18.1a summarizes the valid values. Since this resource is using JSON, the possible
boolean values are *True*
or *False*.

**Table 18.1a: Valid JSON Parameters for Users Create Resource**
