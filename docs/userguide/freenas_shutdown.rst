...
is recommended to "Cancel" the shutdown request and to periodically run :command:`zpool status` from the command line until it is verified that the scrub or
