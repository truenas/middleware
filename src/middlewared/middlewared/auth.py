...
class UserSessionManagerCredentials(SessionManagerCredentials):
    ...
    def __init__(
        ...
        authenticator: TrueNAS_PamAuthenticator | None,
    ):
        """
    ...
    def login(self, session_id: str, origin):
        self.authenticator.login(session_id, origin)
        self.login_at = self.authenticator.login_at

    def logout(self):
        if self.authenticator:
            if self.authenticator.login_at:
...
class ApiKeySessionManagerCredentials(UserSessionManagerCredentials):
    ...
    def __init__(
        ...
        authenticator: TrueNAS_PamAuthenticator
    ):
...
class UnixSocketSessionManagerCredentials(UserSessionManagerCredentials):
    ...
    """
    def __init__(self, user: dict, authenticator: TrueNAS_PamAuthenticator):
...
class AuthenticationContext:
    ...
    """
    pam_hdl: TrueNAS_PamAuthenticator | None = None
