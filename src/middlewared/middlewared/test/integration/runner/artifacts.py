...
def get_artifacts(ctx: Context):
    if ctx.verbose:
        if ctx.ha:
            ...
            get_cmd_result('midclt call core.get_jobs | jq .', f'{ctx.artifacts}/core.get_jobs_nodea.json', ctx.ip)
            get_cmd_result('midclt call core.get_jobs | jq .', f'{ctx.artifacts}/core.get_jobs_nodeb.json', ctx.ip2)
            ...
            get_cmd_result('midclt call core.get_jobs | jq .', f'{ctx.artifacts}/core.get_jobs.json', ctx.ip)
