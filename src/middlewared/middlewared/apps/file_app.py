...
class FileApplication:
    ...
    async def download(self, request):
        ...
        if "auth_token" not in qs:
            ...
            token = await self.middleware.call("auth.get_token", auth_token, app.origin, app=app)
            if not token:
                # Token authentication denied by auth.get_token. In this case the
                # audit entry will be generated by auth.get_token
                denied = True
            else:
