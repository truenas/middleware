...
class SMBSharePurpose(enum.StrEnum):
    ...
    NO_PRESET = 'NO_PRESET'  # Identical to LEGACY_SHARE for older API consumers
    TIMEMACHINE_SHARE = 'TIMEMACHINE_SHARE'
    MULTIPROTOCOL_SHARE = 'MULTIPROTOCOL_SHARE'
    MULTI_PROTOCOL_NFS = 'MULTI_PROTOCOL_NFS'  # Identical to MULTIPROTOCOL_SHARE for older API consumers
    PRIVATE_DATASETS_SHARE = 'PRIVATE_DATASETS_SHARE'
    EXTERNAL_SHARE = 'EXTERNAL_SHARE'
    SMB_WORM_SHARE = 'SMB_WORM_SHARE'


INVALID_SHARE_NAME_CHARACTERS = frozenset({'%', '<', '>', '*', '?', '|', '/', '\\', '+', '=', ';', ':', '"', ',', '[', ']'})
RESERVED_SHARE_NAMES = frozenset({'global', 'printers', 'homes'})
