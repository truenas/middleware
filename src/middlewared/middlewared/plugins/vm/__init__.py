...
from middlewared.api.current import (
    VMEntry, VMCreate, VMUpdate,
    VMCreateArgs, VMCreateResult,
    VMUpdateArgs, VMUpdateResult,
    VMDeleteArgs, VMDeleteResult, VMDeleteOptions,
    VMSupportsVirtualizationArgs, VMSupportsVirtualizationResult,
    VMVirtualizationDetailsArgs, VMVirtualizationDetailsResult, VMVirtualizationDetails,
    VMMaximumSupportedVcpusArgs, VMMaximumSupportedVcpusResult,
    VMFlagsArgs, VMFlagsResult, VMFlags,
    VMGetConsoleArgs, VMGetConsoleResult,
    VMCpuModelChoicesArgs, VMCpuModelChoicesResult,
    VMGuestArchitectureAndMachineChoicesArgs, VMGuestArchitectureAndMachineChoicesResult,
    VMBootloaderOvmfChoicesArgs, VMBootloaderOvmfChoicesResult,
    VMBootloaderOptionsArgs, VMBootloaderOptionsResult, VMBootloaderOptions,
    VMStatusArgs, VMStatusResult, VMStatus,
    VMLogFilePathArgs, VMLogFilePathResult,
    VMLogFileDownloadArgs, VMLogFileDownloadResult,
    VMGetMemoryUsageArgs, VMGetMemoryUsageResult,
    VMGetVmemoryInUseArgs, VMGetVmemoryInUseResult, VMGetVmemoryInUse,
    VMGetAvailableMemoryArgs, VMGetAvailableMemoryResult,
    VMGetVmMemoryInfoArgs, VMGetVmMemoryInfoResult, VMGetVmMemoryInfo,
    VMRandomMacArgs, VMRandomMacResult,
    VMStartArgs, VMStartResult, VMStartOptions,
    VMStopArgs, VMStopResult, VMStopOptions,
    VMPoweroffArgs, VMPoweroffResult,
    VMRestartArgs, VMRestartResult,
    VMSuspendArgs, VMSuspendResult,
    VMResumeArgs, VMResumeResult,
    VMPortWizardArgs, VMPortWizardResult, VMPortWizard,
    VMResolutionChoicesArgs, VMResolutionChoicesResult,
    VMGetDisplayDevicesArgs, VMGetDisplayDevicesResult, VMDisplayDeviceInfo,
    VMGetDisplayWebUriArgs, VMGetDisplayWebUriResult, VMGetDisplayWebUri, VMDisplayWebURIOptions,
    VMCloneArgs, VMCloneResult,
)
...
from .info import (
    supports_virtualization, virtualization_details,
    MAXIMUM_SUPPORTED_VCPUS, vm_flags, get_console, cpu_model_choices,
    bootloader_ovmf_choices, BOOT_LOADER_OPTIONS, log_file_path, log_file_download,
    random_mac, port_wizard, all_used_display_device_ports, resolution_choices,
    get_display_devices as _get_display_devices,
    get_display_web_uri as _get_display_web_uri,
)
from .lifecycle import (
    start_vm, stop_vm, poweroff_vm, resume_vm, suspend_vm, restart_vm, suspend_vms,
    resume_suspended_vms, start_on_boot, handle_shutdown,
)
from .memory import (
    get_memory_usage, get_vmemory_in_use, get_available_memory, get_vm_memory_info,
    init_guest_vmemory, teardown_guest_vmemory,
)
from .snapshot_tasks import (
    periodic_snapshot_task_begin, query_snapshot_begin, get_vms_to_ignore_for_querying_attachments,
)
