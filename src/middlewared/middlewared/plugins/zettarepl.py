...
from middlewared.logger import setup_logging, reconfigure_logging
...
class ZettareplProcess:
    ...
    def __call__(self):
        ...
        c.subscribe('core.reconfigure_logging', lambda *args, **kwargs: reconfigure_logging('zettarepl_file'))
