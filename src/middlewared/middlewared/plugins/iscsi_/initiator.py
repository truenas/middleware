...
from middlewared.api.current import (
    iSCSITargetAuthorizedInitiatorCreateArgs, iSCSITargetAuthorizedInitiatorCreateResult,
    iSCSITargetAuthorizedInitiatorDeleteArgs, iSCSITargetAuthorizedInitiatorDeleteResult,
    iSCSITargetAuthorizedInitiatorEntry, iSCSITargetAuthorizedInitiatorUpdateArgs,
