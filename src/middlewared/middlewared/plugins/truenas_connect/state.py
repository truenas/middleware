...
class TrueNASConnectStateService(Service):
    ...
    @private
    async def check(self, restart_ui: bool = False) -> None:
        ...
        if tnc_config.status == Status.REGISTRATION_FINALIZATION_WAITING.name:
            ...
            await self.call2(
                self.s.tn_connect.finalize.status_update,
            ...
            self.middleware.create_task(self.call2(self.s.tn_connect.acme.initiate_cert_generation))
            ...
            self.middleware.create_task(self.call2(self.s.tn_connect.acme.update_ui))
            ...
            self.middleware.create_task(self.call2(self.s.tn_connect.acme.renew_cert))
