...
class TrueNASConnectModel(sa.Model):
    ...
    tnc_base_url = sa.Column(sa.String(255), nullable=False, default="https://web.truenasconnect.net/")
...
class TrueNASConnectConfigServicePart(ConfigServicePart[TrueNASConnectEntry]):
    ...
    async def update_environment(
        self,
        data: TrueNASConnectUpdateEnvironment,
    ) -> TrueNASConnectEntry:
        ...
        db_payload = {k: str(v) for k, v in data.model_dump(exclude_unset=True).items()}
