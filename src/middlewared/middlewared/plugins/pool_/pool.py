...
from middlewared.api.current import (
    PoolEntry, PoolGetInstanceByNameArgs, PoolGetInstanceByNameResult, PoolPoolNormalizeInfoArgs,
    PoolPoolNormalizeInfoResult, PoolCreateArgs, PoolCreateResult, PoolUpdateArgs, PoolUpdateResult,
...
class PoolService(CRUDService):
    ...
    @api_method(PoolGetInstanceByNameArgs, PoolGetInstanceByNameResult)
    ...
    @api_method(PoolValidateNameArgs, PoolValidateNameResult, roles=['READONLY_ADMIN'])
