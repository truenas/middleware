...
class KerberosRealmService(CRUDService):
    ...
    async def do_delete(self, id_):
        ...
        """
        await self.middlware.call('datastore.delete', self._config.datastore, id_)
        await self.middleware.call('etc.generate', 'kerberos')
...
class KerberosKeytabService(CRUDService):
    ...
    async def store_samba_keytab(self):
        ...
        if not entry:
            ...
            await self.middleware.call('kerberos.keytab.update', id_, updated_entry)
