...
class VirtInstanceService(CRUDService):
    ...
    @job(lock=lambda args: f'instance_create_{args[0].get("name")}')
    ...
    @job(lock=lambda args: f'instance_update_{args[0]}')
    ...
    @job(lock=lambda args: f'instance_delete_{args[0]}')
    ...
    @job(lock=lambda args: f'instance_start_{args[0]}', logs=True)
    ...
    @job(lock=lambda args: f'instance_stop_{args[0]}')
    ...
    @job(lock=lambda args: f'instance_restart_{args[0]}')
