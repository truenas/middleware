...
class ZFSResourceService(Service):
    ...
    @private
    @pass_thread_local_storage
    def load_key(self, tls, dataset: str, **kwargs) -> None:
        ...
        """
        return load_key(self.context, tls, dataset, **kwargs)

    @private
    @pass_thread_local_storage
    def change_key(
        self, tls, dataset: str,
        properties: EncryptionProperties | None = None, key: str | None = None
    ) -> None:
        ...
        """
        return change_key(self.context, tls, dataset, properties, key)

    @private
    @pass_thread_local_storage
    def change_encryption_root(self, tls, dataset: str):
