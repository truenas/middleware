...
LDAP_MAP_KEYS = LDAP_PASSWD_MAP_KEYS | LDAP_SHADOW_MAP_KEYS | LDAP_GROUP_MAP_KEYS | LDAP_NETGROUP_MAP_KEYS
LDAP_ADVANCED_KEYS = LDAP_SEARCH_BASE_KEYS | LDAP_MAP_KEYS
