...
class FailoverEventsService(Service):
    ...
    def vrrp_master(self, job, fobj, ifname, event):
        ...
        self.middleware.create_task(self.call2(self.s.zfs.resource.pool.prefetch_pools))
        ...
        self.middleware.create_task(
            self.middleware.call2(self.middleware.services.tn_connect.state_check, True)
        )
