        ...
        if check:
            ...
            if old_state != new_state:
                if new_state:
                    ...
                    await self.middleware.call('failover.call_remote', 'service.start', [NVMET_SERVICE_NAME])
                else:
                    # Stop on STANDBY node
                    await self.middleware.call('failover.call_remote', 'service.stop', [NVMET_SERVICE_NAME])
