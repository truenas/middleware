...
class AppService(GenericCRUDService[AppEntry, str]):
    ...
    def do_delete(self, job: Job, app_name: str, options: AppDelete) -> typing.Literal[True]:
        ...
        docker compose down will fail as the yaml itself is invalid. In this case this flag can be set to proceed with
        the deletion of the custom app. However if this app had any docker resources in place, then this flag will have
        no effect.
        """
