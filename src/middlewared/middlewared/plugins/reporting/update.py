...
from middlewared.api.current import (
    ReportingEntry, ReportingGraphs, ReportingUpdateArgs, ReportingUpdateResult, ReportingGetDataArgs,
    ReportingGetDataResult, ReportingGraphArgs, ReportingGraphResult
)
...
class ReportingService(ConfigService):
    ...
    @filterable_api_method(roles=['REPORTING_READ'], item=ReportingGraphs, cli_private=True)
