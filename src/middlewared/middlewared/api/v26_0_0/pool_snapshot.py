...
from pydantic import BeforeValidator, Field, AfterValidator, StringConstraints
...
class PoolSnapshotEntryPropertyFields(BaseModel):
    value: LongString = Field(description="Current effective value of the ZFS property as a string.")
    rawvalue: LongString = Field(description="Raw string value of the ZFS property as stored.")
...
class PoolSnapshotCreateTemplate(BaseModel, ABC):
    ...
    suspend_vms: bool = Field(default=False, description="Temporarily suspend VMs before taking snapshot.")
...
class PoolSnapshotUserPropertyUpdate(BaseModel):
    ...
    value: LongString = Field(description="The new value to assign to the user property.")
...
class PoolSnapshotRenameOptions(BaseModel):
    ...
    recursive: bool = Field(default=False, description="Recursively rename the snapshots of all descendant resources.")
