...
class AuthSCRAM(BaseModel):
    ...
    """Scram message type from client. The scram types indicate the message type
    that is represented by the `rfc_str` field.\
    CLIENT_FIRST_MESSAGE - this corresponds with the client-first-message as defined
    in RFC5802.\
