...
class PoolDatasetChangeKeyOptions(BaseModel):
    ...
    pbkdf2iters: int = Field(
        ...
        description=(
            ...
            "attacks but increase unlock time. Default 350,000 balances security and performance."
        ),
    )
...
class PoolDatasetGetQuotaArgs(BaseModel):
    ...
    options: QueryOptions = Field(
        ...
        description="Query options such as sorting and pagination.",
    )


class PoolDatasetGetQuotaResult(BaseModel):
    result: list[PoolDatasetQuota] = Field(description="Array of quota information for the specified quota type.")
...
class PoolDatasetRenameOptions(BaseModel):
    ...
    recursive: bool = Field(default=False, description="Whether to recursively rename child datasets.")
    force: bool = Field(
        default=False,
        description=(
