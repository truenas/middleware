...
class FilesystemSetZfsAttributesArgs(BaseModel):
    path: NonEmptyString = Field(description="Path to the file to set ZFS attributes on.")
...
class FilesystemSetZfsAttributesResult(BaseModel):
    result: ZFSFileAttrsData = Field(description="The updated ZFS file attributes.")
