...
class UserWebUiLoginDisabledAddedEvent(BaseModel):
    ...
    fields: "UserWebUiLoginDisabledAddedEventFields" = Field(description="Event data.")


class UserWebUiLoginDisabledAddedEventFields(BaseModel):
    usernames: list[str] = Field(description="Local administrator accounts that can be used instead.")
