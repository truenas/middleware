...
def upgrade():
    ...
    with op.batch_alter_table('account_bsdgroups', schema=None) as batch_op:
        batch_op.add_column(sa.Column('bsdgrp_sudo_commands1', sa.TEXT(), nullable=False, server_default='[]'))
        batch_op.add_column(sa.Column('bsdgrp_sudo_nopasswd', sa.Boolean(), nullable=False, server_default=False))
    ...
    with op.batch_alter_table('account_bsdusers', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('bsdusr_sudo_nopasswd', sa.Boolean(), nullable=False, server_default=False))
