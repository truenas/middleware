...
def upgrade():
    ...
    op.execute(text("UPDATE network_alias SET alias_vipv6address = '' WHERE alias_vipv6address IS NULL"))
    ...
    op.execute(text("UPDATE services_kubernetes SET cni_config = '{}' WHERE cni_config IS NULL"))
