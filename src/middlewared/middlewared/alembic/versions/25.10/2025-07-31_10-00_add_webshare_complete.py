...
Create Date: 2025-07-31 10:00:00.000000+00:00

This migration creates the WebShare service with the new shares configuration structure:
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('srv_shares', sa.JSON(), nullable=False, server_default='[]'),
        sa.Column('srv_home_directory_template', sa.String(length=255), nullable=False, server_default='{{.Username}}'),
        sa.Column('srv_home_directory_perms', sa.String(length=4), nullable=False, server_default='0700'),
