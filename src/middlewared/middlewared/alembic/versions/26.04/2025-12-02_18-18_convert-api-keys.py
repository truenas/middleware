...
def add_scram_data(api_key, iter, saltb64, hashb64):
    ...
    api_key['stored_key'] = encrypt(b64encode(bytes(auth_data.stored_key)))
    api_key['server_key'] = encrypt(b64encode(bytes(auth_data.server_key)))
