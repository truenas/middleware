...
from middlewared.api.v26_0_0.container import ContainerCreate, ContainerEntry
from middlewared.api.v26_0_0.vm import VMCreate, VMEntry
...
@pytest.mark.parametrize(
    "entry,create,entry_annotation",
    [(VMEntry, VMCreate, str | None), (ContainerEntry, ContainerCreate, str)],
)
def test_entry_is_plain_str_and_create_validates(entry, create, entry_annotation):
    entry_field = entry.model_fields["uuid"]
    assert entry_field.annotation == entry_annotation
