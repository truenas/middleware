...
ROLES = {
    ...
    'CONTAINER_DEVICE_READ': Role(includes=['CONTAINER_READ']),
    'CONTAINER_DEVICE_WRITE': Role(includes=['CONTAINER_WRITE', 'CONTAINER_DEVICE_READ'], stig=None),
    ...
    'SHARING_S3_READ': Role(),
    'SHARING_S3_WRITE': Role(includes=['SHARING_S3_READ']),
    'SHARING_SMB_READ': Role(),
    'SHARING_SMB_WRITE': Role(includes=['SHARING_SMB_READ']),
    'SHARING_WEBSHARE_READ': Role(),
    'SHARING_WEBSHARE_WRITE': Role(includes=['SHARING_WEBSHARE_READ']),
