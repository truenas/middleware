...
CHARTS = {
    ...
    'mapped': {
        'options': [None, 'mapped', 'Bytes', 'mapped', 'Mapped memory', 'line'],
        'lines': [
            ['mapped', 'mapped', 'absolute'],
        ]
    },
    'active': {
        'options': [None, 'active', 'Bytes', 'active', 'Active memory', 'line'],
        'lines': [
            ['active', 'active', 'absolute'],
        ]
    },
    'inactive': {
        'options': [None, 'inactive', 'Bytes', 'inactive', 'inactive memory', 'line'],
        'lines': [
            ['inactive', 'inactive', 'absolute'],
        ]
    },
}
