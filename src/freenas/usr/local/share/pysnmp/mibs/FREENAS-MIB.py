...
# by libsmi2pysnmp-0.1.3 at Tue May 14 11:20:03 2024,
...
class ZPoolHealthType(Integer):
    subtypeSpec = Integer.subtypeSpec+SingleValueConstraint(0,1,2,3,4,5,)
    namedValues = NamedValues(("online", 0), ("degraded", 1), ("faulted", 2), ("offline", 3), ("unavail", 4), ("removed", 5), )
    

# Objects

freeNas = ModuleIdentity((1, 3, 6, 1, 4, 1, 50536)).setRevisions(("2020-05-28 00:00",))
