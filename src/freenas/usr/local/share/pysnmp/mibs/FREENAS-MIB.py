...
# by libsmi2pysnmp-0.1.3 at Thu Sep  7 15:44:28 2017,
...
freeNas = ModuleIdentity((1, 3, 6, 1, 4, 1, 50536)).setRevisions(("2017-09-01 00:00",))
...
zpoolHealth = MibTableColumn((1, 3, 6, 1, 4, 1, 50536, 1, 1, 1, 1, 7), DisplayString()).setMaxAccess("readonly")
...
alertLevel = MibScalar((1, 3, 6, 1, 4, 1, 50536, 2, 2, 1), DisplayString()).setMaxAccess("readonly")
if mibBuilder.loadTexts: alertLevel.setDescription("")
alertMessage = MibScalar((1, 3, 6, 1, 4, 1, 50536, 2, 2, 2), DisplayString()).setMaxAccess("readonly")
...
alert = NotificationType((1, 3, 6, 1, 4, 1, 50536, 2, 1, 1)).setObjects(*(("FREENAS-MIB", "alertMessage"), ("FREENAS-MIB", "alertLevel"), ) )
