...
# by libsmi2pysnmp-0.1.3 at Fri Oct 27 10:20:30 2017,
...
class AlertLevelType(Integer):
    subtypeSpec = Integer.subtypeSpec+SingleValueConstraint(0,30,50,)
    namedValues = NamedValues(("ok", 0), ("warn", 30), ("crit", 50), )
