...
# by libsmi2pysnmp-0.1.3 at Tue Dec 12 18:44:13 2017,
...
class AlertLevelType(Integer):
    subtypeSpec = Integer.subtypeSpec+SingleValueConstraint(20,30,50,)
...
freeNas = ModuleIdentity((1, 3, 6, 1, 4, 1, 50536)).setRevisions(("2017-10-27 00:00",))
...
zfsL2ArcActualSize = MibScalar((1, 3, 6, 1, 4, 1, 50536, 1, 5, 6), Gauge32()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zfsL2ArcActualSize.setDescription("(compressed)")
