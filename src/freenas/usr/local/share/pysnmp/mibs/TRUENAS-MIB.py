...
# by libsmi2pysnmp-0.1.3 at Fri Dec 23 12:59:24 2022,
...
datasetEntry = MibTableRow((1, 3, 6, 1, 4, 1, 50536, 1, 2, 1, 1)).setIndexNames((0, "TRUENAS-MIB", "datasetIndex"))
...
datasetUsedBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 50536, 1, 2, 1, 1, 3), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: datasetUsedBytes.setDescription("The zfs used property value")
datasetAvailableBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 50536, 1, 2, 1, 1, 4), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: datasetAvailableBytes.setDescription("The zfs available property value")
datasetReferencedBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 50536, 1, 2, 1, 1, 5), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: datasetReferencedBytes.setDescription("The zfs referenced property value")
...
zvolEntry = MibTableRow((1, 3, 6, 1, 4, 1, 50536, 1, 3, 1, 1)).setIndexNames((0, "TRUENAS-MIB", "zvolIndex"))
...
zvolUsedBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 50536, 1, 3, 1, 1, 3), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zvolUsedBytes.setDescription("The zfs used property value")
zvolAvailableBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 50536, 1, 3, 1, 1, 4), Counter64()).setMaxAccess("readonly")
if mibBuilder.loadTexts: zvolAvailableBytes.setDescription("The zfs available property value")
zvolReferencedBytes = MibTableColumn((1, 3, 6, 1, 4, 1, 50536, 1, 3, 1, 1, 5), Counter64()).setMaxAccess("readonly")
...
# Objects
mibBuilder.exportSymbols("TRUENAS-MIB", trueNas=trueNas, zfs=zfs, zpool=zpool, zpoolTable=zpoolTable, zpoolEntry=zpoolEntry, zpoolIndex=zpoolIndex, zpoolName=zpoolName, zpoolHealth=zpoolHealth, zpoolReadOps=zpoolReadOps, zpoolWriteOps=zpoolWriteOps, zpoolReadBytes=zpoolReadBytes, zpoolWriteBytes=zpoolWriteBytes, zpoolReadOps1sec=zpoolReadOps1sec, zpoolWriteOps1sec=zpoolWriteOps1sec, zpoolReadBytes1sec=zpoolReadBytes1sec, zpoolWriteBytes1sec=zpoolWriteBytes1sec, dataset=dataset, datasetTable=datasetTable, datasetEntry=datasetEntry, datasetIndex=datasetIndex, datasetDescr=datasetDescr, datasetUsedBytes=datasetUsedBytes, datasetAvailableBytes=datasetAvailableBytes, datasetReferencedBytes=datasetReferencedBytes, zvol=zvol, zvolTable=zvolTable, zvolEntry=zvolEntry, zvolIndex=zvolIndex, zvolDescr=zvolDescr, zvolUsedBytes=zvolUsedBytes, zvolAvailableBytes=zvolAvailableBytes, zvolReferencedBytes=zvolReferencedBytes, arc=arc, zfsArcSize=zfsArcSize, zfsArcMeta=zfsArcMeta, zfsArcData=zfsArcData, zfsArcHits=zfsArcHits, zfsArcMisses=zfsArcMisses, zfsArcC=zfsArcC, zfsArcP=zfsArcP, zfsArcMissPercent=zfsArcMissPercent, zfsArcCacheHitRatio=zfsArcCacheHitRatio, zfsArcCacheMissRatio=zfsArcCacheMissRatio, l2arc=l2arc, zfsL2ArcHits=zfsL2ArcHits, zfsL2ArcMisses=zfsL2ArcMisses, zfsL2ArcRead=zfsL2ArcRead, zfsL2ArcWrite=zfsL2ArcWrite, zfsL2ArcSize=zfsL2ArcSize, zil=zil, zfsZilstatOps1sec=zfsZilstatOps1sec, zfsZilstatOps5sec=zfsZilstatOps5sec, zfsZilstatOps10sec=zfsZilstatOps10sec, notifications=notifications, notificationPrefix=notificationPrefix, notificationObjects=notificationObjects, alertId=alertId, alertLevel=alertLevel, alertMessage=alertMessage, hddTempTable=hddTempTable, hddTempEntry=hddTempEntry, hddTempIndex=hddTempIndex, hddTempDevice=hddTempDevice, hddTempValue=hddTempValue)
