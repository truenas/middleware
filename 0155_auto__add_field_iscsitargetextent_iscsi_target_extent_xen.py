...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetExtent.iscsi_target_extent_xen'
        db.add_column(u'services_iscsitargetextent', 'iscsi_target_extent_xen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'iSCSITargetExtent.iscsi_target_extent_xen'
        db.delete_column(u'services_iscsitargetextent', 'iscsi_target_extent_xen')
