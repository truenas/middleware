...
class TestNFSops:
    ...
    def test_logging_filters(self, start_nfs, nfs_dataset_and_share):
        ...
        with nfs_config():
            ...
            ssh('logger daemon "====== START_NFS_LOGGING_FILTER_TEST - expect mount messages ======"')
            ...
            ssh('logger daemon "====== END_NFS_SYSLOG_FILTER_TEST - expect mount messages ======"')
            ...
            ssh('logger daemon "====== START_NFS_LOGGING_FILTER_TEST - no mountd messages ======"')
            ...
            ssh('logger daemon "====== END_NFS_SYSLOG_FILTER_TEST - no mountd messages ======"')
            syslog_data, errs = async_SSH_done(syslog_tail, 5)    # 5 second timeout
            daemon_data, errs = async_SSH_done(daemon_tail, 5)    # 5 second timeout
