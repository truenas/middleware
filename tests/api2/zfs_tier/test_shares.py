...
Implementation under test:
  ...
  - src/middlewared/middlewared/api/v26_0_0/smb.py:761-840
  - src/middlewared/middlewared/api/v26_0_0/nfs.py:180-191
  - src/middlewared/middlewared/api/v26_0_0/s3.py
"""
...
def test_sharing_smb_update_rejects_tier_field(tier_ds):
    ...
    on SharingSMBUpdateArgs (api/v26_0_0/smb.py:840)."""
...
def test_sharing_nfs_update_rejects_tier_field(tier_ds):
    """tier is Excluded() on the NFS update model (api/v26_0_0/nfs.py:191)."""
