...
def test_02_get_system_general_timezone_choices():
...
def test_02_get_system_general_country_choices():
...
def test_02_get_system_general_kbdmap_choices():
...
def test_03_Checking_timezone_using_api():
    results = GET("/system/general/")
    assert results.status_code == 200, results.text
    data = results.json()
