...
from middlewared.test.integration.assets.directory_service import directory_services 
...
def test_directory_services_ssh(service_type):
    with directory_service(service_type) as ds:
        ...
        try:
            ...
            results = SSH_TEST('ls -la', user_obj['pw_name'], ds['account'].password)
        finally:
