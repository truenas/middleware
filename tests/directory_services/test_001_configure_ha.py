from auto_config import domain, gateway, ha, ha_license, hostname
from middlewared.test.integration.utils import call, fail, truenas_server
...
def test_initialize_truenas():
    ...
    try:
        ...
        # If truenas isn't set up how we expected, there's no purpose in continuing the tests
        fail(exc) 
