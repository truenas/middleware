--- emulators/open-vm-tools/files/patch-modules_freebsd_vmmemctl_os.c	(nonexistent)
+++ emulators/open-vm-tools/files/patch-modules_freebsd_vmmemctl_os.c	(working copy)
@@ -0,0 +1,11 @@ 
