...
console.log("moveTo image not loaded!",_f);
this._animPanTo(0,dojo.fx.easing.expoOut,700);
}
...
console.log("Caught Error",e,"type=",img._type,"oldDestWidth = ",_32,"destWidth",_26,"destX",_30,"oldSourceWidth=",_33,"sourceWidth=",_28,"sourceX = "+_2e);
}
