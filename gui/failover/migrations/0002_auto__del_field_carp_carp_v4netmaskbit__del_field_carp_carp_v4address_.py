...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('network_carp', 'carp_interface',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['network.Interfaces'], unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'network.interfaces': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'int_dhcp': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'int_ipv6auto': ('django.db.models.fields.BooleanField', [], {}),
