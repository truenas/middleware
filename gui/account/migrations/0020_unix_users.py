...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Reset root password for security reasons
        # Root (uid 0) will be the new WebGUI login, as opposed to admin
        orm['account.bsdUsers'].objects.filter(bsdusr_uid=0).update(
            bsdusr_unixhash='*',
        )
