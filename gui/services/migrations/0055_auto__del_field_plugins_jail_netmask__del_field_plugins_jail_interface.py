...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Plugins.jail_netmask'
        db.delete_column('services_plugins', 'jail_netmask')

        # Deleting field 'Plugins.jail_interface'
        db.delete_column('services_plugins', 'jail_interface')

        # Renaming column for 'Plugins.jail_ip' to match new field type.
        db.rename_column('services_plugins', 'jail_ip', 'jail_ip_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Plugins.jail_interface'
        db.add_column('services_plugins', 'jail_interface', self.gf('django.db.models.fields.CharField')(default='', max_length=300), keep_default=False)

        # Renaming column for 'Plugins.jail_ip' to match new field type.
        db.rename_column('services_plugins', 'jail_ip_id', 'jail_ip')
        # Changing field 'Plugins.jail_ip'
        db.alter_column('services_plugins', 'jail_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))
