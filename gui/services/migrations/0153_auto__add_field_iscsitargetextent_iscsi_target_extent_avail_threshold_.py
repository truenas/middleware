...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetExtent.iscsi_target_extent_avail_threshold'
        db.add_column(u'services_iscsitargetextent', 'iscsi_target_extent_avail_threshold',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'iSCSITargetGlobalConfiguration.iscsi_pool_avail_threshold'
        db.add_column(u'services_iscsitargetglobalconfiguration', 'iscsi_pool_avail_threshold',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'iSCSITargetExtent.iscsi_target_extent_avail_threshold'
        db.delete_column(u'services_iscsitargetextent', 'iscsi_target_extent_avail_threshold')

        # Deleting field 'iSCSITargetGlobalConfiguration.iscsi_pool_avail_threshold'
        db.delete_column(u'services_iscsitargetglobalconfiguration', 'iscsi_pool_avail_threshold')
