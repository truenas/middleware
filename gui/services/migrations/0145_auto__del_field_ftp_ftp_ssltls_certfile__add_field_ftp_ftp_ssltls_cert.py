...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FTP.ftp_ssltls_certfile'
        db.delete_column(u'services_ftp', 'ftp_ssltls_certfile')

        # Adding field 'FTP.ftp_ssltls_certificate'
        db.add_column(u'services_ftp', 'ftp_ssltls_certificate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Certificate'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FTP.ftp_ssltls_certfile'
        db.add_column(u'services_ftp', 'ftp_ssltls_certfile',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'FTP.ftp_ssltls_certificate'
        db.delete_column(u'services_ftp', 'ftp_ssltls_certificate_id')
