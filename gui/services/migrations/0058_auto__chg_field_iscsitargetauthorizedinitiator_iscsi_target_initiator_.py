...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'iSCSITargetAuthorizedInitiator.iscsi_target_initiator_auth_network'
        db.alter_column('services_iscsitargetauthorizedinitiator', 'iscsi_target_initiator_auth_network', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'iSCSITargetAuthorizedInitiator.iscsi_target_initiator_auth_network'
        db.alter_column('services_iscsitargetauthorizedinitiator', 'iscsi_target_initiator_auth_network', self.gf('django.db.models.fields.TextField')(max_length=2048))
