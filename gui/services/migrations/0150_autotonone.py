...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for obj in orm['services.iSCSITargetGlobalConfiguration'].objects.all():
            if obj.iscsi_discoveryauthmethod == 'Auto':
                obj.iscsi_discoveryauthmethod = 'None'
            obj.save()
        for obj in orm['services.iSCSITarget'].objects.all():
            if obj.iscsi_target_authtype == 'Auto':
                obj.iscsi_target_authtype = 'None'
            obj.save()
