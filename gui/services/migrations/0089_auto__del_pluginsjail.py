...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding model 'PluginsJail'
        db.create_table(u'services_pluginsjail', (
            ('jail_path', self.gf('freenasUI.freeadmin.models.PathField')(max_length=255)),
            ('plugins_path', self.gf('freenasUI.freeadmin.models.PathField')(max_length=255)),
            ('jail_ipv4netmask', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('jail_mac', self.gf('freenasUI.freeadmin.models.MACField')(default='', max_length=17, blank=True)),
            ('jail_ipv4address', self.gf('freenasUI.contrib.IPAddressField.IPAddressField')()),
            ('jail_name', self.gf('django.db.models.fields.CharField')(default='', max_length=120)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'services', ['PluginsJail'])
    ...
    models = {
        ...
        u'services.iscsitargetportalip': {
            ...
            'iscsi_target_portalip_portal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['services.iSCSITargetPortal']"})
        },
