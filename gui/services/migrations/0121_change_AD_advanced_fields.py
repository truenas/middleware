...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActiveDirectory.ad_gcname'
        db.alter_column(u'services_activedirectory', 'ad_gcname', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'ActiveDirectory.ad_krbname'
        db.alter_column(u'services_activedirectory', 'ad_krbname', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'ActiveDirectory.ad_kpwdname'
        db.alter_column(u'services_activedirectory', 'ad_kpwdname', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'ActiveDirectory.ad_dcname'
        db.alter_column(u'services_activedirectory', 'ad_dcname', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))
        # Deleting field 'CIFS.cifs_srv_domain_logons'
        db.delete_column(u'services_cifs', 'cifs_srv_domain_logons')


    def backwards(self, orm):

        # Changing field 'ActiveDirectory.ad_gcname'
        db.alter_column(u'services_activedirectory', 'ad_gcname', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'ActiveDirectory.ad_krbname'
        db.alter_column(u'services_activedirectory', 'ad_krbname', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'ActiveDirectory.ad_kpwdname'
        db.alter_column(u'services_activedirectory', 'ad_kpwdname', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'ActiveDirectory.ad_dcname'
        db.alter_column(u'services_activedirectory', 'ad_dcname', self.gf('django.db.models.fields.CharField')(default='', max_length=120))
        # Adding field 'CIFS.cifs_srv_domain_logons'
        db.add_column(u'services_cifs', 'cifs_srv_domain_logons',
    ...
    complete_apps = ['services', 'services']
