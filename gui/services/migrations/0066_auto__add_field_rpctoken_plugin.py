...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RPCToken.plugin'
        db.add_column('services_rpctoken', 'plugin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plugins.Plugins'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RPCToken.plugin'
        db.delete_column('services_rpctoken', 'plugin_id')
    ...
    models = {
        ...
        'services.rpctoken': {
            ...
            'plugin': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plugins.Plugins']", 'null': 'True'}),
