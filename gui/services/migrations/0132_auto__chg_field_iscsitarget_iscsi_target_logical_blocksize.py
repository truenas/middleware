...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'iSCSITarget.iscsi_target_logical_blocksize'
        db.alter_column(u'services_iscsitarget', 'iscsi_target_logical_blocksize', self.gf('django.db.models.fields.IntegerField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'iSCSITarget.iscsi_target_logical_blocksize'
        db.alter_column(u'services_iscsitarget', 'iscsi_target_logical_blocksize', self.gf('django.db.models.fields.IntegerField')(max_length=3))
