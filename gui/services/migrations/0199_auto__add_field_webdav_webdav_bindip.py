...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebDAV.webdav_bindip'
        db.add_column(u'services_webdav', 'webdav_bindip',
                      self.gf('freenasUI.freeadmin.models.fields.MultiSelectField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebDAV.webdav_bindip'
        db.delete_column(u'services_webdav', 'webdav_bindip')
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_serial': ('django.db.models.fields.CharField', [], {'default': "'000c29530bfd00'", 'max_length': '16'}),
        ...
        u'services.webdav': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'webdav_bindip': ('freenasUI.freeadmin.models.fields.MultiSelectField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
