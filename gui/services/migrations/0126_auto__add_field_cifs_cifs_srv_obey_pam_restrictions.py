...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS.cifs_srv_obey_pam_restrictions'
        db.add_column(u'services_cifs', 'cifs_srv_obey_pam_restrictions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        db.execute("update services_cifs set cifs_srv_obey_pam_restrictions=1")

    def backwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_obey_pam_restrictions'
        db.delete_column(u'services_cifs', 'cifs_srv_obey_pam_restrictions')
