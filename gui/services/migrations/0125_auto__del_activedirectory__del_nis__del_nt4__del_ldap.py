...
class Migration(SchemaMigration):
    depends_on = (
        ("directoryservice", "0002_directory_services_import"),
    )

    def forwards(self, orm):
        # Deleting model 'ActiveDirectory'
        db.delete_table(u'services_activedirectory')

        # Deleting model 'NIS'
        db.delete_table(u'services_nis')

        # Deleting model 'NT4'
        db.delete_table(u'services_nt4')

        # Deleting model 'LDAP'
        db.delete_table(u'services_ldap')


    def backwards(self, orm):
        # Adding model 'ActiveDirectory'
        db.create_table(u'services_activedirectory', (
        ...
        db.send_create_signal(u'services', ['ActiveDirectory'])

        # Adding model 'NIS'
        db.create_table(u'services_nis', (
        ...
        db.send_create_signal(u'services', ['NIS'])

        # Adding model 'NT4'
        db.create_table(u'services_nt4', (
        ...
        db.send_create_signal(u'services', ['NT4'])

        # Adding model 'LDAP'
        db.create_table(u'services_ldap', (
        ...
        db.send_create_signal(u'services', ['LDAP'])
