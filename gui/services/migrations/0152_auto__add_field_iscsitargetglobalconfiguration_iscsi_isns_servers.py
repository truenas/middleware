...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetGlobalConfiguration.iscsi_isns_servers'
        db.add_column(u'services_iscsitargetglobalconfiguration', 'iscsi_isns_servers',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'iSCSITargetGlobalConfiguration.iscsi_isns_servers'
        db.delete_column(u'services_iscsitargetglobalconfiguration', 'iscsi_isns_servers')
