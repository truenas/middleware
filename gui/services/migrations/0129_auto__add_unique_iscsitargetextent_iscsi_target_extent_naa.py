...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'iSCSITargetExtent', fields ['iscsi_target_extent_naa']
        db.create_unique(u'services_iscsitargetextent', ['iscsi_target_extent_naa'])


    def backwards(self, orm):
        # Deleting unique constraint on 'iSCSITargetExtent', fields ['iscsi_target_extent_naa']
        db.delete_unique(u'services_iscsitargetextent', ['iscsi_target_extent_naa'])
