...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'NFS.nfs_srv_mountd_log'
        db.delete_column(u'services_nfs', 'nfs_srv_mountd_log')

        # Deleting field 'NFS.nfs_srv_statd_lockd_log'
        db.delete_column(u'services_nfs', 'nfs_srv_statd_lockd_log')
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_serial': ('django.db.models.fields.CharField', [], {'default': "'0800276d8a1a00'", 'max_length': '16'}),
