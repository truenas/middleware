...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS.cifs_srv_bindip'
        try:
            db.add_column(u'services_cifs', 'cifs_srv_bindip',
    ...
    def backwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_bindip'
        db.delete_column(u'services_cifs', 'cifs_srv_bindip')
