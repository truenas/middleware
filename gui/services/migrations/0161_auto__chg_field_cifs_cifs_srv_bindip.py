...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CIFS.cifs_srv_bindip'
        db.alter_column(u'services_cifs', 'cifs_srv_bindip', self.gf('freenasUI.freeadmin.models.fields.MultiSelectField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'CIFS.cifs_srv_bindip'
        db.alter_column(u'services_cifs', 'cifs_srv_bindip', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
