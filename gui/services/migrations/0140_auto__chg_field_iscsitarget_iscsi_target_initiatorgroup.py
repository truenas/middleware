...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'services_iscsitarget', 'iscsi_target_initiatorgroup_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITargetAuthorizedInitiator'], null=True, on_delete=models.SET_NULL))

        if not db.dry_run:
            orm['services.iSCSITargetAuthorizedInitiator'].objects.filter(
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'iSCSITarget.iscsi_target_initiatorgroup'
        raise RuntimeError("Cannot reverse this migration. 'iSCSITarget.iscsi_target_initiatorgroup' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'iSCSITarget.iscsi_target_initiatorgroup'
        db.alter_column(u'services_iscsitarget', 'iscsi_target_initiatorgroup_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITargetAuthorizedInitiator']))
    ...
    models = {
        ...
        u'services.iscsitarget': {
            ...
            'iscsi_target_initiatorgroup': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['services.iSCSITargetAuthorizedInitiator']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
