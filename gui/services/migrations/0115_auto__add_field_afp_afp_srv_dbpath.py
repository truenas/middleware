...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AFP.afp_srv_dbpath'
        db.add_column(u'services_afp', 'afp_srv_dbpath',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AFP.afp_srv_dbpath'
        db.delete_column(u'services_afp', 'afp_srv_dbpath')
