...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TFTP.tftp_username'
        db.alter_column('services_tftp', 'tftp_username', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'AFP.afp_srv_guest_user'
        db.alter_column('services_afp', 'afp_srv_guest_user', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'CIFS.cifs_srv_guest'
        db.alter_column('services_cifs', 'cifs_srv_guest', self.gf('django.db.models.fields.CharField')(max_length=120))
