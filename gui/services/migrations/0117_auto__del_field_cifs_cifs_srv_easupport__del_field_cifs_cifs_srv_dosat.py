...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_easupport'
        db.delete_column(u'services_cifs', 'cifs_srv_easupport')

        # Deleting field 'CIFS.cifs_srv_dosattr'
        db.delete_column(u'services_cifs', 'cifs_srv_dosattr')


    def backwards(self, orm):
        # Adding field 'CIFS.cifs_srv_easupport'
        db.add_column(u'services_cifs', 'cifs_srv_easupport',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CIFS.cifs_srv_dosattr'
        db.add_column(u'services_cifs', 'cifs_srv_dosattr',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
