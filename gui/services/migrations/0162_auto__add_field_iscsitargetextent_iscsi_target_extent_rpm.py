...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetExtent.iscsi_target_extent_rpm'
        db.add_column(u'services_iscsitargetextent', 'iscsi_target_extent_rpm',
                      self.gf('django.db.models.fields.CharField')(default=u'SSD', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'iSCSITargetExtent.iscsi_target_extent_rpm'
        db.delete_column(u'services_iscsitargetextent', 'iscsi_target_extent_rpm')
