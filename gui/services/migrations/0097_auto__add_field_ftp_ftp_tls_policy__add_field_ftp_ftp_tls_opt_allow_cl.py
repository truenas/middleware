...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FTP.ftp_tls_policy'
        db.add_column(u'services_ftp', 'ftp_tls_policy',
                      self.gf('django.db.models.fields.CharField')(default='on', max_length=120),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_allow_client_renegotiations'
        db.add_column(u'services_ftp', 'ftp_tls_opt_allow_client_renegotiations',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_allow_dot_login'
        db.add_column(u'services_ftp', 'ftp_tls_opt_allow_dot_login',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_allow_per_user'
        db.add_column(u'services_ftp', 'ftp_tls_opt_allow_per_user',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_common_name_required'
        db.add_column(u'services_ftp', 'ftp_tls_opt_common_name_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_enable_diags'
        db.add_column(u'services_ftp', 'ftp_tls_opt_enable_diags',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_export_cert_data'
        db.add_column(u'services_ftp', 'ftp_tls_opt_export_cert_data',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_no_cert_request'
        db.add_column(u'services_ftp', 'ftp_tls_opt_no_cert_request',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_no_empty_fragments'
        db.add_column(u'services_ftp', 'ftp_tls_opt_no_empty_fragments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_no_session_reuse_required'
        db.add_column(u'services_ftp', 'ftp_tls_opt_no_session_reuse_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_stdenvvars'
        db.add_column(u'services_ftp', 'ftp_tls_opt_stdenvvars',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_use_implicit_ssl'
        db.add_column(u'services_ftp', 'ftp_tls_opt_use_implicit_ssl',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_dns_name_required'
        db.add_column(u'services_ftp', 'ftp_tls_opt_dns_name_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FTP.ftp_tls_opt_ip_address_required'
        db.add_column(u'services_ftp', 'ftp_tls_opt_ip_address_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FTP.ftp_tls_policy'
        db.delete_column(u'services_ftp', 'ftp_tls_policy')

        # Deleting field 'FTP.ftp_tls_opt_allow_client_renegotiations'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_allow_client_renegotiations')

        # Deleting field 'FTP.ftp_tls_opt_allow_dot_login'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_allow_dot_login')

        # Deleting field 'FTP.ftp_tls_opt_allow_per_user'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_allow_per_user')

        # Deleting field 'FTP.ftp_tls_opt_common_name_required'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_common_name_required')

        # Deleting field 'FTP.ftp_tls_opt_enable_diags'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_enable_diags')

        # Deleting field 'FTP.ftp_tls_opt_export_cert_data'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_export_cert_data')

        # Deleting field 'FTP.ftp_tls_opt_no_cert_request'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_no_cert_request')

        # Deleting field 'FTP.ftp_tls_opt_no_empty_fragments'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_no_empty_fragments')

        # Deleting field 'FTP.ftp_tls_opt_no_session_reuse_required'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_no_session_reuse_required')

        # Deleting field 'FTP.ftp_tls_opt_stdenvvars'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_stdenvvars')

        # Deleting field 'FTP.ftp_tls_opt_use_implicit_ssl'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_use_implicit_ssl')

        # Deleting field 'FTP.ftp_tls_opt_dns_name_required'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_dns_name_required')

        # Deleting field 'FTP.ftp_tls_opt_ip_address_required'
        db.delete_column(u'services_ftp', 'ftp_tls_opt_ip_address_required')
