...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActiveDirectory.ad_windows_version'
        db.add_column('services_activedirectory', 'ad_windows_version', self.gf('django.db.models.fields.CharField')(default='windows2000', max_length=120), keep_default=False)

        # Adding field 'ActiveDirectory.ad_spn'
        db.add_column('services_activedirectory', 'ad_spn', self.gf('django.db.models.fields.CharField')(default='', max_length=120), keep_default=False)

        # Adding field 'ActiveDirectory.ad_spnpw'
        db.add_column('services_activedirectory', 'ad_spnpw', self.gf('django.db.models.fields.CharField')(default='', max_length=120), keep_default=False)

        # Adding field 'ActiveDirectory.ad_keytab'
        db.add_column('services_activedirectory', 'ad_keytab', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActiveDirectory.ad_windows_version'
        db.delete_column('services_activedirectory', 'ad_windows_version')

        # Deleting field 'ActiveDirectory.ad_spn'
        db.delete_column('services_activedirectory', 'ad_spn')

        # Deleting field 'ActiveDirectory.ad_spnpw'
        db.delete_column('services_activedirectory', 'ad_spnpw')

        # Deleting field 'ActiveDirectory.ad_keytab'
        db.delete_column('services_activedirectory', 'ad_keytab')
