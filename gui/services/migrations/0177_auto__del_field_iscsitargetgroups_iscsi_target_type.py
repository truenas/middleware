...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'iSCSITargetGroups.iscsi_target_type'
        db.delete_column(u'services_iscsitargetgroups', 'iscsi_target_type')


    def backwards(self, orm):
        # Adding field 'iSCSITargetGroups.iscsi_target_type'
        db.add_column(u'services_iscsitargetgroups', 'iscsi_target_type',
                      self.gf('django.db.models.fields.CharField')(default='ISCSI', max_length=10),
                      keep_default=False)
