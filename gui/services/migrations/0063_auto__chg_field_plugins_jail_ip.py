...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('services_plugins', 'jail_ip_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['network.Alias'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Plugins.jail_ip'
        db.alter_column('services_plugins', 'jail_ip_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['network.Alias']))
    ...
    models = {
        ...
        'services.rpctoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_used': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
