...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActiveDirectory.ad_workgroup'
        db.add_column('services_activedirectory', 'ad_workgroup', self.gf('django.db.models.fields.CharField')(default='', max_length=120), keep_default=False)

        # Adding field 'LDAP.ldap_ssl'
        db.add_column('services_ldap', 'ldap_ssl', self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True), keep_default=False)

        # Adding field 'LDAP.ldap_tls_cacertfile'
        db.add_column('services_ldap', 'ldap_tls_cacertfile', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ActiveDirectory.ad_workgroup'
        db.delete_column('services_activedirectory', 'ad_workgroup')

        # Deleting field 'LDAP.ldap_ssl'
        db.delete_column('services_ldap', 'ldap_ssl')

        # Deleting field 'LDAP.ldap_tls_cacertfile'
        db.delete_column('services_ldap', 'ldap_tls_cacertfile')
