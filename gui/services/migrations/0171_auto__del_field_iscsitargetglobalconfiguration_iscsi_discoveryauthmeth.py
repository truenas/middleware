...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'iSCSITargetGlobalConfiguration.iscsi_discoveryauthmethod'
        db.delete_column(u'services_iscsitargetglobalconfiguration', 'iscsi_discoveryauthmethod')

        # Deleting field 'iSCSITargetGlobalConfiguration.iscsi_discoveryauthgroup'
        db.delete_column(u'services_iscsitargetglobalconfiguration', 'iscsi_discoveryauthgroup')


    def backwards(self, orm):
        # Adding field 'iSCSITargetGlobalConfiguration.iscsi_discoveryauthmethod'
        db.add_column(u'services_iscsitargetglobalconfiguration', 'iscsi_discoveryauthmethod',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=120),
                      keep_default=False)

        # Adding field 'iSCSITargetGlobalConfiguration.iscsi_discoveryauthgroup'
        db.add_column(u'services_iscsitargetglobalconfiguration', 'iscsi_discoveryauthgroup',
