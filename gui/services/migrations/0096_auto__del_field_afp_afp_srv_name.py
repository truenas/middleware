...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'services_afp', 'afp_srv_name')


    def backwards(self, orm):
        # Adding field 'AFP.afp_srv_name'
        db.add_column(u'services_afp', 'afp_srv_name',
                      self.gf('django.db.models.fields.CharField')(default='freenas', max_length=120),
                      keep_default=False)
