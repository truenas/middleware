...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FiberChannelToTarget.fc_target'
        db.alter_column(u'services_fiberchanneltotarget', 'fc_target_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITarget'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FiberChannelToTarget.fc_target'
        raise RuntimeError("Cannot reverse this migration. 'FiberChannelToTarget.fc_target' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FiberChannelToTarget.fc_target'
        db.alter_column(u'services_fiberchanneltotarget', 'fc_target_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITarget']))
