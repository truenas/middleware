...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NFS.nfs_srv_v4_v3owner'
        db.add_column(u'services_nfs', 'nfs_srv_v4_v3owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NFS.nfs_srv_v4_v3owner'
        db.delete_column(u'services_nfs', 'nfs_srv_v4_v3owner')
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_serial': ('django.db.models.fields.CharField', [], {'default': "'0007430a5ae609'", 'max_length': '16'}),
