...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AFP.afp_srv_map_acls'
        db.add_column(u'services_afp', 'afp_srv_map_acls',
                      self.gf('django.db.models.fields.CharField')(default='rights', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AFP.afp_srv_map_acls'
        db.delete_column(u'services_afp', 'afp_srv_map_acls')
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_serial': ('django.db.models.fields.CharField', [], {'default': "'00505685a9c400'", 'max_length': '16'}),
