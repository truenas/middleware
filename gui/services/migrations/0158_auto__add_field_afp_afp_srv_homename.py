...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AFP.afp_srv_homename'
        db.add_column(u'services_afp', 'afp_srv_homename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AFP.afp_srv_homename'
        db.delete_column(u'services_afp', 'afp_srv_homename')
