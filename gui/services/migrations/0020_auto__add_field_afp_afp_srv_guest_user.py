...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AFP.afp_srv_guest_user'
        db.delete_column('services_afp', 'afp_srv_guest_user')
    ...
    models = {
        ...
        'services.afp': {
            ...
            'afp_srv_guest_user': ('django.db.models.fields.CharField', [], {'default': "'www'", 'max_length': '120'}),
