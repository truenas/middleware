...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS.cifs_srv_min_protocol'
        db.add_column(u'services_cifs', 'cifs_srv_min_protocol',
    ...
    def backwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_min_protocol'
        db.delete_column(u'services_cifs', 'cifs_srv_min_protocol')

        # Deleting field 'CIFS.cifs_srv_max_protocol'
        db.delete_column(u'services_cifs', 'cifs_srv_max_protocol')
