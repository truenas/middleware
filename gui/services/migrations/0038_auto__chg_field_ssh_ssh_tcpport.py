...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SSH.ssh_tcpport'
        db.alter_column('services_ssh', 'ssh_tcpport', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'SSH.ssh_tcpport'
        db.alter_column('services_ssh', 'ssh_tcpport', self.gf('django.db.models.fields.CharField')(max_length=120))
