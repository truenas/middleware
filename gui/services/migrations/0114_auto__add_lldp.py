...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LLDP'
        db.create_table(u'services_lldp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lldp_intdesc', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('lldp_country', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('lldp_location', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'services', ['LLDP'])

        if not db.dry_run:
            orm['services.LLDP'].objects.create()

            orm['services.services'].objects.create(
                srv_service='lldp',
                srv_enable=False,
            )
    ...
    complete_apps = ['account', 'services']
