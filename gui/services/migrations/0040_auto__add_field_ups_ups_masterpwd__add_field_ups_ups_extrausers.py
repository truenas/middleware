...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UPS.ups_masterpwd'
        db.add_column('services_ups', 'ups_masterpwd', self.gf('django.db.models.fields.CharField')(default='fixmepass', max_length=30), keep_default=False)

        # Adding field 'UPS.ups_extrausers'
        db.add_column('services_ups', 'ups_extrausers', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UPS.ups_masterpwd'
        db.delete_column('services_ups', 'ups_masterpwd')

        # Deleting field 'UPS.ups_extrausers'
        db.delete_column('services_ups', 'ups_extrausers')
