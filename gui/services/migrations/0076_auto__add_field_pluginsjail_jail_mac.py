...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PluginsJail.jail_mac'
        db.add_column('services_pluginsjail', 'jail_mac',
                      self.gf('freenasUI.freeadmin.models.MACField')(default='', max_length=17, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PluginsJail.jail_mac'
        db.delete_column('services_pluginsjail', 'jail_mac')
