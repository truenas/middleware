...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetGlobalConfiguration.iscsi_experimental_target'
        db.add_column(u'services_iscsitargetglobalconfiguration', 'iscsi_experimental_target',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Workaround sqlite south bug
        if not db.dry_run:
            orm['services.iSCSITargetGlobalConfiguration'].objects.update(
