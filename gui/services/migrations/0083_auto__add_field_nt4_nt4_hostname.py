...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NT4.nt4_hostname'
        db.add_column('services_nt4', 'nt4_hostname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NT4.nt4_hostname'
        db.delete_column('services_nt4', 'nt4_hostname')
    ...
    models = {
        ...
        'services.nt4': {
            ...
            'nt4_hostname': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
