...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm.UPS.objects.all():
            try:
                obj.ups_shutdowntimer = int(obj.ups_shutdowntimer)
            except:
                obj.ups_shutdowntimer = 30
            obj.save()

        # Changing field 'UPS.ups_shutdowntimer'
        db.alter_column(u'services_ups', 'ups_shutdowntimer', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'UPS.ups_shutdowntimer'
        db.alter_column(u'services_ups', 'ups_shutdowntimer', self.gf('django.db.models.fields.CharField')(max_length=120))
