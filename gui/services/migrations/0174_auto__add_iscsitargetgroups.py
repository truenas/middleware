...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'iSCSITargetGroups'
        db.create_table(u'services_iscsitargetgroups', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('iscsi_target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITarget'])),
            ('iscsi_target_type', self.gf('django.db.models.fields.CharField')(default='ISCSI', max_length=10)),
            ('iscsi_target_portalgroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITargetPortal'])),
            ('iscsi_target_initiatorgroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITargetAuthorizedInitiator'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('iscsi_target_authtype', self.gf('django.db.models.fields.CharField')(default='None', max_length=120)),
            ('iscsi_target_authgroup', self.gf('django.db.models.fields.IntegerField')(max_length=120, null=True, blank=True)),
            ('iscsi_target_initialdigest', self.gf('django.db.models.fields.CharField')(default='Auto', max_length=120)),
        ))
        db.send_create_signal(u'services', ['iSCSITargetGroups'])


    def backwards(self, orm):
        # Deleting model 'iSCSITargetGroups'
        db.delete_table(u'services_iscsitargetgroups')
