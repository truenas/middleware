...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'iSCSITargetGroups', fields ['iscsi_target', 'iscsi_target_portalgroup']
        db.create_unique(u'services_iscsitargetgroups', ['iscsi_target_id', 'iscsi_target_portalgroup_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'iSCSITargetGroups', fields ['iscsi_target', 'iscsi_target_portalgroup']
        db.delete_unique(u'services_iscsitargetgroups', ['iscsi_target_id', 'iscsi_target_portalgroup_id'])
