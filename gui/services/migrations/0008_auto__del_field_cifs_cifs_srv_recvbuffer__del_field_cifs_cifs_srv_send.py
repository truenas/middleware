...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CIFS.cifs_srv_recvbuffer'
        db.delete_column('services_cifs', 'cifs_srv_recvbuffer')

        # Deleting field 'CIFS.cifs_srv_sendbuffer'
        db.delete_column('services_cifs', 'cifs_srv_sendbuffer')


    def backwards(self, orm):
        
        # Adding field 'CIFS.cifs_srv_recvbuffer'
        db.add_column('services_cifs', 'cifs_srv_recvbuffer', self.gf('django.db.models.fields.CharField')(default='0', max_length=120, blank=True), keep_default=False)

        # Adding field 'CIFS.cifs_srv_sendbuffer'
        db.add_column('services_cifs', 'cifs_srv_sendbuffer', self.gf('django.db.models.fields.CharField')(default='0', max_length=120, blank=True), keep_default=False)
