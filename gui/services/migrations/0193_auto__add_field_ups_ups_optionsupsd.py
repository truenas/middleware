...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UPS.ups_optionsupsd'
        db.add_column(u'services_ups', 'ups_optionsupsd',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UPS.ups_optionsupsd'
        db.delete_column(u'services_ups', 'ups_optionsupsd')
