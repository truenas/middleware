...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'iSCSITargetExtent.iscsi_target_extent_naa'
        db.alter_column(u'services_iscsitargetextent', 'iscsi_target_extent_naa', self.gf('django.db.models.fields.CharField')(unique=True, max_length=34))

    def backwards(self, orm):

        # Changing field 'iSCSITargetExtent.iscsi_target_extent_naa'
        db.alter_column(u'services_iscsitargetextent', 'iscsi_target_extent_naa', self.gf('django.db.models.fields.CharField')(max_length=18, unique=True))
