...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DynamicDNS.ddns_ipserver'
        db.add_column(u'services_dynamicdns', 'ddns_ipserver',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DynamicDNS.ddns_ipserver'
        db.delete_column(u'services_dynamicdns', 'ddns_ipserver')
