...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for tgt in orm['services.iSCSITarget'].objects.all():
            group = orm['services.iSCSITargetGroups']()
            group.iscsi_target = tgt
            group.iscsi_target_portalgroup = tgt.iscsi_target_portalgroup
            group.iscsi_target_initiatorgroup = tgt.iscsi_target_initiatorgroup
            group.iscsi_target_authtype = tgt.iscsi_target_authtype
            group.iscsi_target_authgroup = tgt.iscsi_target_authgroup
            group.iscsi_target_initialdigest = tgt.iscsi_target_initialdigest
            group.save()
