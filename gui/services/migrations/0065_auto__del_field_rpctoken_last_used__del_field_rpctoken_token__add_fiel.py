...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RPCToken.last_used'
        db.delete_column('services_rpctoken', 'last_used')

        # Deleting field 'RPCToken.token'
        db.delete_column('services_rpctoken', 'token')

        # Adding field 'RPCToken.key'
        db.add_column('services_rpctoken', 'key', self.gf('django.db.models.fields.CharField')(default='', max_length=1024), keep_default=False)

        # Adding field 'RPCToken.secret'
        db.add_column('services_rpctoken', 'secret', self.gf('django.db.models.fields.CharField')(default='', max_length=1024), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RPCToken.last_used'
        db.add_column('services_rpctoken', 'last_used', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'RPCToken.token'
        raise RuntimeError("Cannot reverse this migration. 'RPCToken.token' and its values cannot be restored.")

        # Deleting field 'RPCToken.key'
        db.delete_column('services_rpctoken', 'key')

        # Deleting field 'RPCToken.secret'
        db.delete_column('services_rpctoken', 'secret')
