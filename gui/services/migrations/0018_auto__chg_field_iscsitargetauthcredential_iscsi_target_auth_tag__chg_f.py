...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'iSCSITargetAuthCredential.iscsi_target_auth_tag'
        db.alter_column('services_iscsitargetauthcredential', 'iscsi_target_auth_tag', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'iSCSITarget.iscsi_target_alias'
        db.alter_column('services_iscsitarget', 'iscsi_target_alias', self.gf('django.db.models.fields.CharField')(max_length=120, unique=True, null=True))

        # Changing field 'iSCSITargetAuthorizedInitiator.iscsi_target_initiator_tag'
        db.alter_column('services_iscsitargetauthorizedinitiator', 'iscsi_target_initiator_tag', self.gf('django.db.models.fields.IntegerField')(unique=True))


    def backwards(self, orm):
        
        # Changing field 'iSCSITargetAuthCredential.iscsi_target_auth_tag'
        db.alter_column('services_iscsitargetauthcredential', 'iscsi_target_auth_tag', self.gf('django.db.models.fields.IntegerField')(max_length=120))

        # Changing field 'iSCSITarget.iscsi_target_alias'
        db.alter_column('services_iscsitarget', 'iscsi_target_alias', self.gf('django.db.models.fields.CharField')(max_length=120, unique=True))

        # Changing field 'iSCSITargetAuthorizedInitiator.iscsi_target_initiator_tag'
        db.alter_column('services_iscsitargetauthorizedinitiator', 'iscsi_target_initiator_tag', self.gf('django.db.models.fields.IntegerField')(max_length=120, unique=True))
