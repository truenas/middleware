...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_authmodel'
        db.delete_column(u'services_cifs', 'cifs_srv_authmodel')


    def backwards(self, orm):
        # Adding field 'CIFS.cifs_srv_authmodel'
        db.add_column(u'services_cifs', 'cifs_srv_authmodel',
                      self.gf('django.db.models.fields.CharField')(default='user', max_length=10),
                      keep_default=False)
