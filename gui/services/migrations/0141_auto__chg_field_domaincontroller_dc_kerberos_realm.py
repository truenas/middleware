...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'services_domaincontroller', 'dc_kerberos_realm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosRealm'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'DomainController.dc_kerberos_realm'
        db.alter_column(u'services_domaincontroller', 'dc_kerberos_realm_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['directoryservice.KerberosRealm'], on_delete=models.DO_NOTHING))
