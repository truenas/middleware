...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NFS.nfs_srv_async'
        db.delete_column('services_nfs', 'nfs_srv_async')


    def backwards(self, orm):
        
        # Adding field 'NFS.nfs_srv_async'
        db.add_column('services_nfs', 'nfs_srv_async', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
