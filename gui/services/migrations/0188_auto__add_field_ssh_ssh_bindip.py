...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SSH.ssh_bindip'
        db.add_column(u'services_ssh', 'ssh_bindip',
                      self.gf('freenasUI.freeadmin.models.fields.MultiSelectField')(default='', max_length=350, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SSH.ssh_bindip'
        db.delete_column(u'services_ssh', 'ssh_bindip')
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_serial': ('django.db.models.fields.CharField', [], {'default': "'0800277e602605'", 'max_length': '16'}),
        ...
        u'services.ssh': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ssh_bindip': ('freenasUI.freeadmin.models.fields.MultiSelectField', [], {'default': "''", 'max_length': '350', 'blank': 'True'}),
