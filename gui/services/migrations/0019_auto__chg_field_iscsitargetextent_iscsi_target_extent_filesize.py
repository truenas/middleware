...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'iSCSITargetExtent.iscsi_target_extent_filesize'
        db.alter_column('services_iscsitargetextent', 'iscsi_target_extent_filesize', self.gf('django.db.models.fields.CharField')(max_length=120))


    def backwards(self, orm):
        
        # Changing field 'iSCSITargetExtent.iscsi_target_extent_filesize'
        db.alter_column('services_iscsitargetextent', 'iscsi_target_extent_filesize', self.gf('django.db.models.fields.IntegerField')(max_length=120))
