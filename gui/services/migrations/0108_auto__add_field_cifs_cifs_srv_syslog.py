...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS.cifs_srv_syslog'
        db.add_column(u'services_cifs', 'cifs_srv_syslog',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_syslog'
        db.delete_column(u'services_cifs', 'cifs_srv_syslog')
