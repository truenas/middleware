...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'iSCSITarget.iscsi_firstburst'
        db.delete_column('services_iscsitarget', 'iscsi_firstburst')

        # Deleting field 'iSCSITarget.iscsi_maxburst'
        db.delete_column('services_iscsitarget', 'iscsi_maxburst')

        # Deleting field 'iSCSITarget.iscsi_maxsesh'
        db.delete_column('services_iscsitarget', 'iscsi_maxsesh')

        # Deleting field 'iSCSITarget.iscsi_maxrecdata'
        db.delete_column('services_iscsitarget', 'iscsi_maxrecdata')

        # Deleting field 'iSCSITarget.iscsi_discoveryauthmethod'
        db.delete_column('services_iscsitarget', 'iscsi_discoveryauthmethod')

        # Deleting field 'iSCSITarget.iscsi_maxconnect'
        db.delete_column('services_iscsitarget', 'iscsi_maxconnect')

        # Deleting field 'iSCSITarget.iscsi_basename'
        db.delete_column('services_iscsitarget', 'iscsi_basename')

        # Deleting field 'iSCSITarget.iscsi_nopinint'
        db.delete_column('services_iscsitarget', 'iscsi_nopinint')

        # Deleting field 'iSCSITarget.iscsi_discoveryauthgroup'
        db.delete_column('services_iscsitarget', 'iscsi_discoveryauthgroup')

        # Deleting field 'iSCSITarget.iscsi_toggleluc'
        db.delete_column('services_iscsitarget', 'iscsi_toggleluc')

        # Deleting field 'iSCSITarget.iscsi_io'
        db.delete_column('services_iscsitarget', 'iscsi_io')

        # Adding field 'iSCSITarget.iscsi_target_name'
        db.add_column('services_iscsitarget', 'iscsi_target_name', self.gf('django.db.models.fields.CharField')(default='delete', unique=True, max_length=120), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_alias'
        db.add_column('services_iscsitarget', 'iscsi_target_alias', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=120, blank=True), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_type'
        db.add_column('services_iscsitarget', 'iscsi_target_type', self.gf('django.db.models.fields.CharField')(default='delete', max_length=120), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_flags'
        db.add_column('services_iscsitarget', 'iscsi_target_flags', self.gf('django.db.models.fields.CharField')(default='delete', max_length=120), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_portalgroup'
        db.add_column('services_iscsitarget', 'iscsi_target_portalgroup', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=120), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_initiatorgroup'
        db.add_column('services_iscsitarget', 'iscsi_target_initiatorgroup', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=120), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_authtype'
        db.add_column('services_iscsitarget', 'iscsi_target_authtype', self.gf('django.db.models.fields.CharField')(default='Auto', max_length=120), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_authgroup'
        db.add_column('services_iscsitarget', 'iscsi_target_authgroup', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=120), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_initialdigest'
        db.add_column('services_iscsitarget', 'iscsi_target_initialdigest', self.gf('django.db.models.fields.CharField')(default='Auto', max_length=120), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_queue_depth'
        db.add_column('services_iscsitarget', 'iscsi_target_queue_depth', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=3), keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_logical_blocksize'
        db.add_column('services_iscsitarget', 'iscsi_target_logical_blocksize', self.gf('django.db.models.fields.IntegerField')(default=512, max_length=3), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # We cannot add back in field 'iSCSITarget.iscsi_firstburst'
        raise RuntimeError(
            "Cannot reverse this migration. 'iSCSITarget.iscsi_firstburst' and its values cannot be restored.")

        # We cannot add back in field 'iSCSITarget.iscsi_maxburst'
        raise RuntimeError(
            "Cannot reverse this migration. 'iSCSITarget.iscsi_maxburst' and its values cannot be restored.")

        # We cannot add back in field 'iSCSITarget.iscsi_maxsesh'
        raise RuntimeError(
            "Cannot reverse this migration. 'iSCSITarget.iscsi_maxsesh' and its values cannot be restored.")

        # We cannot add back in field 'iSCSITarget.iscsi_maxrecdata'
        raise RuntimeError(
            "Cannot reverse this migration. 'iSCSITarget.iscsi_maxrecdata' and its values cannot be restored.")

        # Adding field 'iSCSITarget.iscsi_discoveryauthmethod'
        db.add_column('services_iscsitarget', 'iscsi_discoveryauthmethod', self.gf('django.db.models.fields.CharField')(default='auto', max_length=120), keep_default=False)

        # We cannot add back in field 'iSCSITarget.iscsi_maxconnect'
        raise RuntimeError(
            "Cannot reverse this migration. 'iSCSITarget.iscsi_maxconnect' and its values cannot be restored.")

        # We cannot add back in field 'iSCSITarget.iscsi_basename'
        raise RuntimeError(
            "Cannot reverse this migration. 'iSCSITarget.iscsi_basename' and its values cannot be restored.")

        # We cannot add back in field 'iSCSITarget.iscsi_nopinint'
        raise RuntimeError(
            "Cannot reverse this migration. 'iSCSITarget.iscsi_nopinint' and its values cannot be restored.")
        ...
        # Deleting field 'iSCSITarget.iscsi_target_alias'
        db.delete_column('services_iscsitarget', 'iscsi_target_alias')

        # Deleting field 'iSCSITarget.iscsi_target_type'
        db.delete_column('services_iscsitarget', 'iscsi_target_type')

        # Deleting field 'iSCSITarget.iscsi_target_flags'
        db.delete_column('services_iscsitarget', 'iscsi_target_flags')

        # Deleting field 'iSCSITarget.iscsi_target_portalgroup'
        db.delete_column('services_iscsitarget', 'iscsi_target_portalgroup')

        # Deleting field 'iSCSITarget.iscsi_target_initiatorgroup'
        db.delete_column('services_iscsitarget', 'iscsi_target_initiatorgroup')

        # Deleting field 'iSCSITarget.iscsi_target_authtype'
        db.delete_column('services_iscsitarget', 'iscsi_target_authtype')

        # Deleting field 'iSCSITarget.iscsi_target_authgroup'
        db.delete_column('services_iscsitarget', 'iscsi_target_authgroup')

        # Deleting field 'iSCSITarget.iscsi_target_initialdigest'
        db.delete_column('services_iscsitarget', 'iscsi_target_initialdigest')

        # Deleting field 'iSCSITarget.iscsi_target_queue_depth'
        db.delete_column('services_iscsitarget', 'iscsi_target_queue_depth')

        # Deleting field 'iSCSITarget.iscsi_target_logical_blocksize'
        db.delete_column('services_iscsitarget', 'iscsi_target_logical_blocksize')
    ...
    models = {
        ...
        'services.iscsitargetglobalconfiguration': {
            ...
            'iscsi_luc_authnetwork': ('django.db.models.fields.CharField', [], {'default': "'127.0.0.1/8'", 'max_length': '120'}),
