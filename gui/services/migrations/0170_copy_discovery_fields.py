...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        try:
            gc = orm['services.iSCSITargetGlobalConfiguration'].objects.order_by('-id')[0]
        except:
            return

        for obj in orm['services.iSCSITargetPortal'].objects.all():
            obj.iscsi_target_portal_discoveryauthmethod = gc.iscsi_discoveryauthmethod
            obj.iscsi_target_portal_discoveryauthgroup = gc.iscsi_discoveryauthgroup
            obj.save()
