...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('services_cifs', 'cifs_srv_homedir_browseable_enable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CIFS.cifs_srv_homedir_browseable_enable'
        db.delete_column('services_cifs', 'cifs_srv_homedir_browseable_enable')
