...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'iSCSITarget.iscsi_target_serial'
        db.add_column('services_iscsitarget', 'iscsi_target_serial', self.gf('django.db.models.fields.CharField')(default='10000001', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'iSCSITarget.iscsi_target_serial'
        db.delete_column('services_iscsitarget', 'iscsi_target_serial')
