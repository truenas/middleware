...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_unix_extensions'
        db.add_column('services_activedirectory', 'ad_unix_extensions',
    ...
    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_unix_extensions'
        db.delete_column('services_activedirectory', 'ad_unix_extensions')
