...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_nss_info'
        db.add_column(u'services_activedirectory', 'ad_nss_info',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_nss_info'
        db.delete_column(u'services_activedirectory', 'ad_nss_info')
