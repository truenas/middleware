...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AFP.afp_srv_global_aux'
        db.add_column(u'services_afp', 'afp_srv_global_aux',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AFP.afp_srv_global_aux'
        db.delete_column(u'services_afp', 'afp_srv_global_aux')
