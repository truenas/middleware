...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('services_cifs', 'cifs_srv_authmodel', self.gf('django.db.models.fields.CharField')(default='user', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CIFS.cifs_srv_authmodel'
        db.delete_column('services_cifs', 'cifs_srv_authmodel')
