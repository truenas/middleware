...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NFS.nfs_srv_v4_root'
        db.delete_column(u'services_nfs', 'nfs_srv_v4_root')


    def backwards(self, orm):
        # Adding field 'NFS.nfs_srv_v4_root'
        db.add_column(u'services_nfs', 'nfs_srv_v4_root',
                      self.gf('freenasUI.freeadmin.models.fields.PathField')(default='/', max_length=255, null=True, blank=True),
                      keep_default=False)
