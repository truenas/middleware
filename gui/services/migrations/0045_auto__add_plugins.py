...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('services_plugins', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('jail_path', self.gf('freenasUI.freeadmin.models.PathField')(default='', max_length=255, null=True, blank=True)),
            ('jail_name', self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True)),
            ('jail_ip', self.gf('django.db.models.fields.IPAddressField')(default='', max_length=15, blank=True)),
            ('jail_netmask', self.gf('django.db.models.fields.IPAddressField')(default='', max_length=15, blank=True)),
            ('plugins_path', self.gf('freenasUI.freeadmin.models.PathField')(default='', max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('services', ['Plugins'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('services_plugins')
