...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('services_plugins', (
            ...
            ('jail_path', self.gf('freeadmin.models.PathField')(default='', max_length=255, null=True, blank=True)),
            ...
            ('plugins_path', self.gf('freeadmin.models.PathField')(default='', max_length=255, null=True, blank=True)),
        ))
