...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetExtent.iscsi_target_extent_blocksize'
        db.add_column(u'services_iscsitargetextent', 'iscsi_target_extent_blocksize',
                      self.gf('django.db.models.fields.IntegerField')(default=512, max_length=4),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'iSCSITargetExtent.iscsi_target_extent_blocksize'
        db.delete_column(u'services_iscsitargetextent', 'iscsi_target_extent_blocksize')

        # Deleting field 'iSCSITargetExtent.iscsi_target_extent_pblocksize'
        db.delete_column(u'services_iscsitargetextent', 'iscsi_target_extent_pblocksize')
