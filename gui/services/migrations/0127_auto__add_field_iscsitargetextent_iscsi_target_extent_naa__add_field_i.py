...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetExtent.iscsi_target_extent_naa'
        db.add_column(u'services_iscsitargetextent', 'iscsi_target_extent_naa',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=18, blank=True),
                      keep_default=False)

        # Adding field 'iSCSITargetExtent.iscsi_target_extent_insecure_tpc'
        db.add_column(u'services_iscsitargetextent', 'iscsi_target_extent_insecure_tpc',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'services_iscsitargetextent', 'iscsi_target_extent_naa')

        # Deleting field 'iSCSITargetExtent.iscsi_target_extent_insecure_tpc'
        db.delete_column(u'services_iscsitargetextent', 'iscsi_target_extent_insecure_tpc')
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_naa': ('django.db.models.fields.CharField', [], {'max_length': '18', 'blank': 'True'}),
        ...
        u'services.iscsitargetglobalconfiguration': {
            ...
            'iscsi_experimental_target': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
