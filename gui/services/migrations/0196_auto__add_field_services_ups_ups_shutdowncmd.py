...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UPS.ups_shutdowncmd'
        db.add_column(u'services_ups', 'ups_shutdowncmd',
                      self.gf('django.db.models.fields.CharField')(default='/sbin/shutdown -p now', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UPS.ups_shutdowncmd'
        db.delete_column(u'services_ups', 'ups_shutdowncmd')
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_serial': ('django.db.models.fields.CharField', [], {'default': "'0050569b2dfd00'", 'max_length': '16'}),
