...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SNMP.snmp_v3'
        db.add_column(u'services_snmp', 'snmp_v3',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)

        # Adding field 'SNMP.snmp_v3_username'
        db.add_column(u'services_snmp', 'snmp_v3_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'SNMP.snmp_v3_password'
        db.add_column(u'services_snmp', 'snmp_v3_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SNMP.snmp_v3'
        db.delete_column(u'services_snmp', 'snmp_v3')

        # Deleting field 'SNMP.snmp_v3_username'
        db.delete_column(u'services_snmp', 'snmp_v3_username')

        # Deleting field 'SNMP.snmp_v3_password'
        db.delete_column(u'services_snmp', 'snmp_v3_password')
