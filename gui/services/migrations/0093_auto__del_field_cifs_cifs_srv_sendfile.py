...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_sendfile'
        db.delete_column(u'services_cifs', 'cifs_srv_sendfile')


    def backwards(self, orm):
        # Adding field 'CIFS.cifs_srv_sendfile'
        db.add_column(u'services_cifs', 'cifs_srv_sendfile',
