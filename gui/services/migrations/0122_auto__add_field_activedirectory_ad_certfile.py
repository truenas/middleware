...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_certfile'
        db.add_column(u'services_activedirectory', 'ad_certfile',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_certfile'
        db.delete_column(u'services_activedirectory', 'ad_certfile')
