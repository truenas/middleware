...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'services_iscsitarget', 'iscsi_target_portalgroup_id')

        # Deleting field 'iSCSITarget.iscsi_target_authgroup'
        db.delete_column(u'services_iscsitarget', 'iscsi_target_authgroup')

        # Deleting field 'iSCSITarget.iscsi_target_initialdigest'
        db.delete_column(u'services_iscsitarget', 'iscsi_target_initialdigest')

        # Deleting field 'iSCSITarget.iscsi_target_authtype'
        db.delete_column(u'services_iscsitarget', 'iscsi_target_authtype')

        # Deleting field 'iSCSITarget.iscsi_target_initiatorgroup'
        db.delete_column(u'services_iscsitarget', 'iscsi_target_initiatorgroup_id')


    def backwards(self, orm):
        # Adding field 'iSCSITarget.iscsi_target_portalgroup'
        db.add_column(u'services_iscsitarget', 'iscsi_target_portalgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['services.iSCSITargetPortal']),
                      keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_authgroup'
        db.add_column(u'services_iscsitarget', 'iscsi_target_authgroup',
        ...
        db.add_column(u'services_iscsitarget', 'iscsi_target_initialdigest',
                      self.gf('django.db.models.fields.CharField')(default='Auto', max_length=120),
                      keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_authtype'
        db.add_column(u'services_iscsitarget', 'iscsi_target_authtype',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=120),
                      keep_default=False)

        # Adding field 'iSCSITarget.iscsi_target_initiatorgroup'
        db.add_column(u'services_iscsitarget', 'iscsi_target_initiatorgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITargetAuthorizedInitiator'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'services.iscsitargetgroups': {
            'Meta': {'object_name': 'iSCSITargetGroups'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'iscsi_target_type': ('django.db.models.fields.CharField', [], {'default': "'ISCSI'", 'max_length': '10'})
        },
