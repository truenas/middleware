...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_netbiosname_b'
        db.delete_column(u'services_cifs', 'cifs_srv_netbiosname_b')

        # Deleting field 'CIFS.cifs_srv_netbiosalias'
        db.delete_column(u'services_cifs', 'cifs_srv_netbiosalias')
