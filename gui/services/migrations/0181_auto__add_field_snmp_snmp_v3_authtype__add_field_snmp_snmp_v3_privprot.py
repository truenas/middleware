...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SNMP.snmp_v3_authtype'
        db.add_column(u'services_snmp', 'snmp_v3_authtype',
                      self.gf('django.db.models.fields.CharField')(default='SHA', max_length=3),
                      keep_default=False)

        # Adding field 'SNMP.snmp_v3_privproto'
        db.add_column(u'services_snmp', 'snmp_v3_privproto',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SNMP.snmp_v3_privpassphrase'
        db.add_column(u'services_snmp', 'snmp_v3_privpassphrase',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SNMP.snmp_v3_authtype'
        db.delete_column(u'services_snmp', 'snmp_v3_authtype')

        # Deleting field 'SNMP.snmp_v3_privproto'
        db.delete_column(u'services_snmp', 'snmp_v3_privproto')

        # Deleting field 'SNMP.snmp_v3_privpassphrase'
        db.delete_column(u'services_snmp', 'snmp_v3_privpassphrase')
    ...
    models = {
        ...
        u'services.fiberchanneltotarget': {
            ...
            'fc_target': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['services.iSCSITarget']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'services.ftp': {
        ...
        u'services.snmp': {
            ...
            'snmp_v3_authtype': ('django.db.models.fields.CharField', [], {'default': "'SHA'", 'max_length': '3'}),
