...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('sharing', '0029_home_share'),
    )

    def forwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_homedir_enable'
        db.delete_column(u'services_cifs', 'cifs_srv_homedir_enable')

        # Deleting field 'CIFS.cifs_srv_homedir_aux'
        db.delete_column(u'services_cifs', 'cifs_srv_homedir_aux')

        # Deleting field 'CIFS.cifs_srv_homedir'
        db.delete_column(u'services_cifs', 'cifs_srv_homedir')

        # Deleting field 'CIFS.cifs_srv_homedir_browseable_enable'
        db.delete_column(u'services_cifs', 'cifs_srv_homedir_browseable_enable')


    def backwards(self, orm):
        # Adding field 'CIFS.cifs_srv_homedir_enable'
        db.add_column(u'services_cifs', 'cifs_srv_homedir_enable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CIFS.cifs_srv_homedir_aux'
        db.add_column(u'services_cifs', 'cifs_srv_homedir_aux',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'CIFS.cifs_srv_homedir'
        db.add_column(u'services_cifs', 'cifs_srv_homedir',
                      self.gf('freenasUI.freeadmin.models.fields.PathField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CIFS.cifs_srv_homedir_browseable_enable'
        db.add_column(u'services_cifs', 'cifs_srv_homedir_browseable_enable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
