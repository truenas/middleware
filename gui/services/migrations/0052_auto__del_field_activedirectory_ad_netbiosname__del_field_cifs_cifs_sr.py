...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ActiveDirectory.ad_netbiosname'
        db.delete_column('services_activedirectory', 'ad_netbiosname')

        # Deleting field 'CIFS.cifs_srv_netbiosname'
        db.delete_column('services_cifs', 'cifs_srv_netbiosname')

        # Deleting field 'AFP.afp_srv_name'
        db.delete_column('services_afp', 'afp_srv_name')


    def backwards(self, orm):

        hostname_config = db.execute('SELECT gc_hostname FROM network_globalconfiguration ORDER BY -id LIMIT 1')
        if hostname_config:
            hostname = str(hostname_config[0][0])
        else:
            hostname = 'freenas'

        # Adding field 'ActiveDirectory.ad_netbiosname'
        db.add_column('services_activedirectory', 'ad_netbiosname', self.gf('django.db.models.fields.CharField')(default=hostname, max_length=120), keep_default=False)

        # Adding field 'CIFS.cifs_srv_netbiosname'
        db.add_column('services_cifs', 'cifs_srv_netbiosname', self.gf('django.db.models.fields.CharField')(default=hostname, max_length=120), keep_default=False)

        # Adding field 'AFP.afp_srv_name'
        db.add_column('services_afp', 'afp_srv_name', self.gf('django.db.models.fields.CharField')(default=hostname, max_length=120), keep_default=False)
