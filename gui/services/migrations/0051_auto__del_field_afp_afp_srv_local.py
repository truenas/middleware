...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AFP.afp_srv_local'
        db.delete_column('services_afp', 'afp_srv_local')


    def backwards(self, orm):
        
        # Adding field 'AFP.afp_srv_local'
        db.add_column('services_afp', 'afp_srv_local', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
