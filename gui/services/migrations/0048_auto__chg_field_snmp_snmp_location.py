...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SNMP.snmp_location'
        db.alter_column('services_snmp', 'snmp_location', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'SNMP.snmp_location'
        db.alter_column('services_snmp', 'snmp_location', self.gf('django.db.models.fields.CharField')(max_length=120))
