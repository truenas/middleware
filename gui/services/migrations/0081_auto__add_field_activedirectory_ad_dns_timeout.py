...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_dns_timeout'
        db.add_column('services_activedirectory', 'ad_dns_timeout',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_dns_timeout'
        db.delete_column('services_activedirectory', 'ad_dns_timeout')
