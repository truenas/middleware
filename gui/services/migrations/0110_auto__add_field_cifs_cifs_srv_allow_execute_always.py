...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS.cifs_srv_allow_execute_always'
        db.add_column(u'services_cifs', 'cifs_srv_allow_execute_always',
    ...
    def backwards(self, orm):
        # Deleting field 'CIFS.cifs_srv_allow_execute_always'
        db.delete_column(u'services_cifs', 'cifs_srv_allow_execute_always')
