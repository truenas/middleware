...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('services_nis', 'nis_servers',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8192),
                      keep_default=False)

        # Adding field 'NIS.nis_secure_mode'
        db.add_column('services_nis', 'nis_secure_mode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NIS.nis_manycast'
    ...
    def backwards(self, orm):
        # Deleting field 'NIS.nis_servers'
        db.delete_column('services_nis', 'nis_servers')

        # Deleting field 'NIS.nis_secure_mode'
        db.delete_column('services_nis', 'nis_secure_mode')

        # Deleting field 'NIS.nis_manycast'
        db.delete_column('services_nis', 'nis_manycast')
    ...
    models = {
        ...
        'services.nis': {
            ...
            'nis_servers': ('django.db.models.fields.CharField', [], {'max_length': '8192'})
        },
        'services.nt4': {
