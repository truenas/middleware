...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebDAV.webdav_certssl'
        db.add_column(u'services_webdav', 'webdav_certssl',
    ...
    def backwards(self, orm):
        # Deleting field 'WebDAV.webdav_certssl'
        db.delete_column(u'services_webdav', 'webdav_certssl_id')
