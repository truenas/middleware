...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        row = db.execute("select ad_adminname, ad_adminpw from services_activedirectory")
        if row and row[0]:
            row = row[0]
            ad_adminname = row[0]
            ad_adminpw = row[1]

        # Deleting field 'ActiveDirectory.ad_adminname'
        db.delete_column(u'services_activedirectory', 'ad_adminname')

        # Deleting field 'ActiveDirectory.ad_adminpw'
        db.delete_column(u'services_activedirectory', 'ad_adminpw')

        # Adding field 'ActiveDirectory.ad_bindname'
        db.add_column(u'services_activedirectory', 'ad_bindname',
                      self.gf('django.db.models.fields.CharField')(default=ad_adminname, max_length=120),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_bindpw'
        db.add_column(u'services_activedirectory', 'ad_bindpw',
                      self.gf('django.db.models.fields.CharField')(default=ad_adminpw, max_length=120),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_use_keytab'
        db.add_column(u'services_activedirectory', 'ad_use_keytab',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_keytab'
        db.add_column(u'services_activedirectory', 'ad_keytab',
    ...
    def backwards(self, orm):
        ...
        row = db.execute("select ad_bindname, ad_bindpw from services_activedirectory")
        if row and row[0]:
            row = row[0]
            ad_bindname = row[0]
            ad_bindpw = row[1]

        # Adding field 'ActiveDirectory.ad_adminname'
        db.add_column(u'services_activedirectory', 'ad_adminname',
                      self.gf('django.db.models.fields.CharField')(default=ad_bindname, max_length=120),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_adminpw'
        db.add_column(u'services_activedirectory', 'ad_adminpw',
                      self.gf('django.db.models.fields.CharField')(default=ad_bindpw, max_length=120),
                      keep_default=False)

        # Deleting field 'ActiveDirectory.ad_bindname'
        db.delete_column(u'services_activedirectory', 'ad_bindname')

        # Deleting field 'ActiveDirectory.ad_bindpw'
        db.delete_column(u'services_activedirectory', 'ad_bindpw')

        # Deleting field 'ActiveDirectory.ad_use_keytab'
        db.delete_column(u'services_activedirectory', 'ad_use_keytab')

        # Deleting field 'ActiveDirectory.ad_keytab'
        db.delete_column(u'services_activedirectory', 'ad_keytab')
