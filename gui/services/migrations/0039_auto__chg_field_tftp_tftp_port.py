...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TFTP.tftp_port'
        db.alter_column('services_tftp', 'tftp_port', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'TFTP.tftp_port'
        db.alter_column('services_tftp', 'tftp_port', self.gf('django.db.models.fields.CharField')(max_length=120))
