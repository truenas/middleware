...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AFP.afp_srv_homedir_enable'
        db.add_column(u'services_afp', 'afp_srv_homedir_enable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AFP.afp_srv_homedir'
        db.add_column(u'services_afp', 'afp_srv_homedir',
                      self.gf('freenasUI.freeadmin.models.fields.PathField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AFP.afp_srv_homedir_enable'
        db.delete_column(u'services_afp', 'afp_srv_homedir_enable')

        # Deleting field 'AFP.afp_srv_homedir'
        db.delete_column(u'services_afp', 'afp_srv_homedir')
