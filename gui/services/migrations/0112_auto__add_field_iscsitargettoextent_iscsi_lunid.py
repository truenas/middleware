...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetToExtent.iscsi_lunid'
        db.add_column(u'services_iscsitargettoextent', 'iscsi_lunid',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'iSCSITargetToExtent.iscsi_lunid'
        db.delete_column(u'services_iscsitargettoextent', 'iscsi_lunid')
