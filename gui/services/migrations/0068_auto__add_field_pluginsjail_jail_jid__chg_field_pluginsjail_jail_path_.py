...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PluginsJail.jail_jid'
        db.add_column('services_pluginsjail', 'jail_jid', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, unique=True), keep_default=False)

        # Changing field 'PluginsJail.jail_path'
        db.alter_column('services_pluginsjail', 'jail_path', self.gf('freenasUI.freeadmin.models.PathField')(max_length=255))

        # Changing field 'PluginsJail.plugins_path'
        db.alter_column('services_pluginsjail', 'plugins_path', self.gf('freenasUI.freeadmin.models.PathField')(max_length=255))

        # Changing field 'CIFS.cifs_srv_guest'
        db.alter_column('services_cifs', 'cifs_srv_guest', self.gf('freenasUI.freeadmin.models.UserField')(max_length=120))
        ...
        # Changing field 'TFTP.tftp_username'
        db.alter_column('services_tftp', 'tftp_username', self.gf('freenasUI.freeadmin.models.UserField')(max_length=120))

        # Changing field 'TFTP.tftp_directory'
        db.alter_column('services_tftp', 'tftp_directory', self.gf('freenasUI.freeadmin.models.PathField')(max_length=255))

        # Changing field 'AFP.afp_srv_guest_user'
        db.alter_column('services_afp', 'afp_srv_guest_user', self.gf('freenasUI.freeadmin.models.UserField')(max_length=120))
        ...
        # Changing field 'RsyncMod.rsyncmod_path'
        db.alter_column('services_rsyncmod', 'rsyncmod_path', self.gf('freenasUI.freeadmin.models.PathField')(max_length=255))

        # Changing field 'RsyncMod.rsyncmod_user'
        db.alter_column('services_rsyncmod', 'rsyncmod_user', self.gf('freenasUI.freeadmin.models.UserField')(max_length=120))

        # Changing field 'RsyncMod.rsyncmod_group'
        db.alter_column('services_rsyncmod', 'rsyncmod_group', self.gf('freenasUI.freeadmin.models.GroupField')(max_length=120))


    def backwards(self, orm):
        
        # Deleting field 'PluginsJail.jail_jid'
        db.delete_column('services_pluginsjail', 'jail_jid')

        # Changing field 'PluginsJail.jail_path'
        db.alter_column('services_pluginsjail', 'jail_path', self.gf('freeadmin.models.PathField')(max_length=255))

        # Changing field 'PluginsJail.plugins_path'
        db.alter_column('services_pluginsjail', 'plugins_path', self.gf('freeadmin.models.PathField')(max_length=255))

        # Changing field 'CIFS.cifs_srv_guest'
        db.alter_column('services_cifs', 'cifs_srv_guest', self.gf('freeadmin.models.UserField')(max_length=120))

        # Changing field 'CIFS.cifs_srv_homedir'
        db.alter_column('services_cifs', 'cifs_srv_homedir', self.gf('freeadmin.models.PathField')(max_length=255, null=True))

        # Changing field 'TFTP.tftp_username'
        db.alter_column('services_tftp', 'tftp_username', self.gf('freeadmin.models.UserField')(max_length=120))

        # Changing field 'TFTP.tftp_directory'
        db.alter_column('services_tftp', 'tftp_directory', self.gf('freeadmin.models.PathField')(max_length=255))

        # Changing field 'AFP.afp_srv_guest_user'
        db.alter_column('services_afp', 'afp_srv_guest_user', self.gf('freeadmin.models.UserField')(max_length=120))

        # Changing field 'FTP.ftp_anonpath'
        db.alter_column('services_ftp', 'ftp_anonpath', self.gf('freeadmin.models.PathField')(max_length=255, null=True))

        # Changing field 'RsyncMod.rsyncmod_path'
        db.alter_column('services_rsyncmod', 'rsyncmod_path', self.gf('freeadmin.models.PathField')(max_length=255))

        # Changing field 'RsyncMod.rsyncmod_user'
        db.alter_column('services_rsyncmod', 'rsyncmod_user', self.gf('freeadmin.models.UserField')(max_length=120))

        # Changing field 'RsyncMod.rsyncmod_group'
        db.alter_column('services_rsyncmod', 'rsyncmod_group', self.gf('freeadmin.models.GroupField')(max_length=120))
    ...
    models = {
        ...
        'services.pluginsjail': {
            ...
            'jail_jid': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'unique': 'True'}),
