...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SSH.ssh_kerberosauth'
        db.add_column(u'services_ssh', 'ssh_kerberosauth',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SSH.ssh_kerberosauth'
        db.delete_column(u'services_ssh', 'ssh_kerberosauth')
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_serial': ('django.db.models.fields.CharField', [], {'default': "'0800277e602604'", 'max_length': '16'}),
