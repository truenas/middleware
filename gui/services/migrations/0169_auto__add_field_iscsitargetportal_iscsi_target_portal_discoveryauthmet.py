...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetPortal.iscsi_target_portal_discoveryauthmethod'
        db.add_column(u'services_iscsitargetportal', 'iscsi_target_portal_discoveryauthmethod',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=120),
                      keep_default=False)

        # Adding field 'iSCSITargetPortal.iscsi_target_portal_discoveryauthgroup'
        db.add_column(u'services_iscsitargetportal', 'iscsi_target_portal_discoveryauthgroup',
                      self.gf('django.db.models.fields.IntegerField')(max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'iSCSITargetPortal.iscsi_target_portal_discoveryauthmethod'
        db.delete_column(u'services_iscsitargetportal', 'iscsi_target_portal_discoveryauthmethod')

        # Deleting field 'iSCSITargetPortal.iscsi_target_portal_discoveryauthgroup'
        db.delete_column(u'services_iscsitargetportal', 'iscsi_target_portal_discoveryauthgroup')
