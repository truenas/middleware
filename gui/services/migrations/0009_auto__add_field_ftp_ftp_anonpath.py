...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FTP.ftp_anonpath'
        db.add_column('services_ftp', 'ftp_anonpath', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.MountPoint'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FTP.ftp_anonpath'
        db.delete_column('services_ftp', 'ftp_anonpath_id')
