...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITarget.iscsi_target_mode'
        db.add_column(u'services_iscsitarget', 'iscsi_target_mode',
                      self.gf('django.db.models.fields.CharField')(default='iscsi', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'iSCSITarget.iscsi_target_mode'
        db.delete_column(u'services_iscsitarget', 'iscsi_target_mode')
