...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'iSCSITargetGlobalConfiguration.iscsi_discoveryauthgroup'
        db.alter_column('services_iscsitargetglobalconfiguration', 'iscsi_discoveryauthgroup', self.gf('django.db.models.fields.IntegerField')(max_length=120, null=True))

        # Changing field 'iSCSITarget.iscsi_target_authgroup'
        db.alter_column('services_iscsitarget', 'iscsi_target_authgroup', self.gf('django.db.models.fields.IntegerField')(max_length=120, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'iSCSITargetGlobalConfiguration.iscsi_discoveryauthgroup'
        db.alter_column('services_iscsitargetglobalconfiguration', 'iscsi_discoveryauthgroup', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'iSCSITarget.iscsi_target_authgroup'
        db.alter_column('services_iscsitarget', 'iscsi_target_authgroup', self.gf('django.db.models.fields.IntegerField')(max_length=120))
