...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainController.dc_storage'
        db.add_column(u'services_domaincontroller', 'dc_storage',
                      self.gf('freenasUI.freeadmin.models.fields.PathField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainController.dc_storage'
        db.delete_column(u'services_domaincontroller', 'dc_storage')
    ...
    models = {
        ...
        u'services.domaincontroller': {
            ...
            'dc_storage': ('freenasUI.freeadmin.models.fields.PathField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
