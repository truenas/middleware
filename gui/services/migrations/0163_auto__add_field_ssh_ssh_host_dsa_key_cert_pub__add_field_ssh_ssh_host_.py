...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SSH.ssh_host_dsa_key_cert_pub'
        db.add_column(u'services_ssh', 'ssh_host_dsa_key_cert_pub',
                      self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SSH.ssh_host_ecdsa_key_cert_pub'
        db.add_column(u'services_ssh', 'ssh_host_ecdsa_key_cert_pub',
                      self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SSH.ssh_host_ed25519_key_cert_pub'
        db.add_column(u'services_ssh', 'ssh_host_ed25519_key_cert_pub',
                      self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SSH.ssh_host_rsa_key_cert_pub'
        db.add_column(u'services_ssh', 'ssh_host_rsa_key_cert_pub',
                      self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SSH.ssh_host_dsa_key_cert_pub'
        db.delete_column(u'services_ssh', 'ssh_host_dsa_key_cert_pub')

        # Deleting field 'SSH.ssh_host_ecdsa_key_cert_pub'
        db.delete_column(u'services_ssh', 'ssh_host_ecdsa_key_cert_pub')

        # Deleting field 'SSH.ssh_host_ed25519_key_cert_pub'
        db.delete_column(u'services_ssh', 'ssh_host_ed25519_key_cert_pub')

        # Deleting field 'SSH.ssh_host_rsa_key_cert_pub'
        db.delete_column(u'services_ssh', 'ssh_host_rsa_key_cert_pub')
