...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NFS.nfs_srv_servers'
        db.alter_column('services_nfs', 'nfs_srv_servers', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'NFS.nfs_srv_servers'
        db.alter_column('services_nfs', 'nfs_srv_servers', self.gf('django.db.models.fields.CharField')(max_length=120))
