...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AFP.afp_srv_dbpath'
        db.alter_column(u'services_afp', 'afp_srv_dbpath', self.gf('freenasUI.freeadmin.models.fields.PathField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'AFP.afp_srv_dbpath'
        db.alter_column(u'services_afp', 'afp_srv_dbpath', self.gf('django.db.models.fields.CharField')(default='', max_length=120))
