...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'iSCSITargetExtent.iscsi_target_extent_ro'
        db.add_column(u'services_iscsitargetextent', 'iscsi_target_extent_ro',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'iSCSITargetExtent.iscsi_target_extent_ro'
        db.delete_column(u'services_iscsitargetextent', 'iscsi_target_extent_ro')
