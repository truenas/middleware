...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CIFS.cifs_srv_homedir'
        db.add_column('services_cifs', 'cifs_srv_homedir', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['storage.MountPoint'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CIFS.cifs_srv_homedir'
        db.delete_column('services_cifs', 'cifs_srv_homedir_id')
    ...
    models = {
        ...
        'services.cifs': {
            ...
            'cifs_srv_homedir': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['storage.MountPoint']", 'null': 'True'}),
