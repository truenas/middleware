...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FTP.ftp_masqaddress'
        db.alter_column('services_ftp', 'ftp_masqaddress', self.gf('django.db.models.fields.CharField')(max_length=120))


    def backwards(self, orm):
        
        # Changing field 'FTP.ftp_masqaddress'
        db.alter_column('services_ftp', 'ftp_masqaddress', self.gf('django.db.models.fields.IPAddressField')(max_length=15))
