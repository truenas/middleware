...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'iSCSITargetToExtent', fields ['iscsi_target', 'iscsi_extent']
        db.delete_unique(u'services_iscsitargettoextent', ['iscsi_target_id', 'iscsi_extent_id'])

        # Adding unique constraint on 'iSCSITargetToExtent', fields ['iscsi_extent']
        db.create_unique(u'services_iscsitargettoextent', ['iscsi_extent_id'])
    ...
    models = {
        ...
        u'services.iscsitargettoextent': {
            'Meta': {'unique_together': "(('iscsi_target', 'iscsi_extent'),)", 'object_name': 'iSCSITargetToExtent'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
