...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NFS.nfs_srv_mountd_port'
        db.add_column(u'services_nfs', 'nfs_srv_mountd_port',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'NFS.nfs_srv_rpcstatd_port'
        db.add_column(u'services_nfs', 'nfs_srv_rpcstatd_port',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'NFS.nfs_srv_rpclockd_port'
        db.add_column(u'services_nfs', 'nfs_srv_rpclockd_port',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NFS.nfs_srv_mountd_port'
        db.delete_column(u'services_nfs', 'nfs_srv_mountd_port')

        # Deleting field 'NFS.nfs_srv_rpcstatd_port'
        db.delete_column(u'services_nfs', 'nfs_srv_rpcstatd_port')

        # Deleting field 'NFS.nfs_srv_rpclockd_port'
        db.delete_column(u'services_nfs', 'nfs_srv_rpclockd_port')
