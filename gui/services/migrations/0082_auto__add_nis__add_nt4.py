...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NIS'
        db.create_table('services_nis', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nis_domain', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal('services', ['NIS'])

        # Adding model 'NT4'
        db.create_table('services_nt4', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('services', ['NT4'])


    def backwards(self, orm):
        # Deleting model 'NIS'
        db.delete_table('services_nis')

        # Deleting model 'NT4'
        db.delete_table('services_nt4')
