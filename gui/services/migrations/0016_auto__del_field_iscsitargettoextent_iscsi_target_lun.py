...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'iSCSITargetToExtent.iscsi_target_lun'
        db.delete_column('services_iscsitargettoextent', 'iscsi_target_lun')


    def backwards(self, orm):
        
        # Adding field 'iSCSITargetToExtent.iscsi_target_lun'
        db.add_column('services_iscsitargettoextent', 'iscsi_target_lun', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=120), keep_default=False)
