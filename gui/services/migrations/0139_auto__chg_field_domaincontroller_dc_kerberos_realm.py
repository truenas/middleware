...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DomainController.dc_kerberos_realm'
        db.alter_column(u'services_domaincontroller', 'dc_kerberos_realm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosRealm'], on_delete=models.DO_NOTHING))

    def backwards(self, orm):

        # Changing field 'DomainController.dc_kerberos_realm'
        db.alter_column(u'services_domaincontroller', 'dc_kerberos_realm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosRealm']))
    ...
    models = {
        ...
        u'services.domaincontroller': {
            ...
            'dc_kerberos_realm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['directoryservice.KerberosRealm']", 'on_delete': 'models.DO_NOTHING'}),
