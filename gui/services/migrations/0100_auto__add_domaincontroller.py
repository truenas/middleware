...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DomainController'
        db.create_table(u'services_domaincontroller', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dc_realm', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('dc_domain', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('dc_role', self.gf('django.db.models.fields.CharField')(default='dc', max_length=120)),
            ('dc_dns_backend', self.gf('django.db.models.fields.CharField')(default='SAMBA_INTERNAL', max_length=120)),
            ('dc_dns_forwarder', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('dc_forest_level', self.gf('django.db.models.fields.CharField')(default='2003', max_length=120)),
            ('dc_passwd', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal(u'services', ['DomainController'])

        if not db.dry_run:
            dc = orm.DomainController()
            dc.save()

            s = orm.Services()
            s.srv_service = 'domaincontroller'
            s.srv_enable = False 
            s.save()


    def backwards(self, orm):
        # Deleting model 'DomainController'
        db.delete_table(u'services_domaincontroller')

        if not db.dry_run:
            orm.Services.objects.filter(srv_service='domaincontroller').delete()
