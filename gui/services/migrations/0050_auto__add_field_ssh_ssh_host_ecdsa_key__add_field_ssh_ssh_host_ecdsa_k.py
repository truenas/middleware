...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SSH.ssh_host_ecdsa_key'
        db.add_column('services_ssh', 'ssh_host_ecdsa_key', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True), keep_default=False)

        # Adding field 'SSH.ssh_host_ecdsa_key_pub'
        db.add_column('services_ssh', 'ssh_host_ecdsa_key_pub', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SSH.ssh_host_ecdsa_key'
        db.delete_column('services_ssh', 'ssh_host_ecdsa_key')

        # Deleting field 'SSH.ssh_host_ecdsa_key_pub'
        db.delete_column('services_ssh', 'ssh_host_ecdsa_key_pub')
