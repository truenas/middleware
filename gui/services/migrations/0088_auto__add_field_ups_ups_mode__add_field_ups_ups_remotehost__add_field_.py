...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UPS.ups_remotehost'
        db.add_column(u'services_ups', 'ups_remotehost',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UPS.ups_remotehost'
        db.delete_column(u'services_ups', 'ups_remotehost')
