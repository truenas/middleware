...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding service 'WebDAV'
        dav = orm.WebDAV()
        dav.save()
        s = orm.Services()
        s.srv_service = 'webdav'
        s.srv_enable = False
        s.save()
    ...
    def backwards(self, orm):
        # Deleting service webdav from services_services in sqlite entry
        db.execute("delete from services_services where srv_service=%s",["webdav"])
    ...
    models = {
        ...
        u'services.domaincontroller': {
            ...
            'dc_kerberos_realm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['directoryservice.KerberosRealm']"}),
