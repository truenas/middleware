...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CIFS.cifs_srv_homedir_aux'
        db.add_column('services_cifs', 'cifs_srv_homedir_aux', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'CIFS.cifs_srv_smb_options'
        db.alter_column('services_cifs', 'cifs_srv_smb_options', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Plugins.jail_path'
        db.alter_column('services_plugins', 'jail_path', self.gf('freeadmin.models.PathField')(default='', max_length=255))

        # Changing field 'Plugins.plugins_path'
        db.alter_column('services_plugins', 'plugins_path', self.gf('freeadmin.models.PathField')(default='', max_length=255))

        # Changing field 'iSCSITargetGlobalConfiguration.iscsi_lucport'
        db.alter_column('services_iscsitargetglobalconfiguration', 'iscsi_lucport', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'CIFS.cifs_srv_homedir_aux'
        db.delete_column('services_cifs', 'cifs_srv_homedir_aux')

        # Changing field 'CIFS.cifs_srv_smb_options'
        db.alter_column('services_cifs', 'cifs_srv_smb_options', self.gf('django.db.models.fields.TextField')(max_length=120))

        # Changing field 'Plugins.jail_path'
        db.alter_column('services_plugins', 'jail_path', self.gf('freeadmin.models.PathField')(max_length=255, null=True))

        # Changing field 'Plugins.plugins_path'
        db.alter_column('services_plugins', 'plugins_path', self.gf('freeadmin.models.PathField')(max_length=255, null=True))
    ...
    models = {
        ...
        'services.iscsitargetauthorizedinitiator': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iscsi_target_initiator_auth_network': ('django.db.models.fields.CharField', [], {'default': "'ALL'", 'max_length': '255'}),
