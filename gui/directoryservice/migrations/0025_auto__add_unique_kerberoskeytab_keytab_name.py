...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'KerberosKeytab', fields ['keytab_name']
        db.create_unique(u'directoryservice_kerberoskeytab', ['keytab_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'KerberosKeytab', fields ['keytab_name']
        db.delete_unique(u'directoryservice_kerberoskeytab', ['keytab_name'])
