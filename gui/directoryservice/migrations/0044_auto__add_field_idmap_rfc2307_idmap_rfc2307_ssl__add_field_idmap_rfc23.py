...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'idmap_rfc2307.idmap_rfc2307_ssl'
        db.add_column(u'directoryservice_idmap_rfc2307', 'idmap_rfc2307_ssl',
                      self.gf('django.db.models.fields.CharField')(default='off', max_length=120),
                      keep_default=False)

        # Adding field 'idmap_rfc2307.idmap_rfc2307_certificate'
        db.add_column(u'directoryservice_idmap_rfc2307', 'idmap_rfc2307_certificate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.CertificateAuthority'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'idmap_ldap.idmap_ldap_ssl'
        db.add_column(u'directoryservice_idmap_ldap', 'idmap_ldap_ssl',
                      self.gf('django.db.models.fields.CharField')(default='off', max_length=120),
                      keep_default=False)

        # Adding field 'idmap_ldap.idmap_ldap_certificate'
        db.add_column(u'directoryservice_idmap_ldap', 'idmap_ldap_certificate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.CertificateAuthority'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'idmap_rfc2307.idmap_rfc2307_ssl'
        db.delete_column(u'directoryservice_idmap_rfc2307', 'idmap_rfc2307_ssl')

        # Deleting field 'idmap_rfc2307.idmap_rfc2307_certificate'
        db.delete_column(u'directoryservice_idmap_rfc2307', 'idmap_rfc2307_certificate_id')

        # Deleting field 'idmap_ldap.idmap_ldap_ssl'
        db.delete_column(u'directoryservice_idmap_ldap', 'idmap_ldap_ssl')

        # Deleting field 'idmap_ldap.idmap_ldap_certificate'
        db.delete_column(u'directoryservice_idmap_ldap', 'idmap_ldap_certificate_id')
