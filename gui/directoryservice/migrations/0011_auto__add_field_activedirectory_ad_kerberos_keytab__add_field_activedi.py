...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_kerberos_keytab'
        db.add_column(u'directoryservice_activedirectory', 'ad_kerberos_keytab',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosKeytab'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_kerberos_realm'
        db.add_column(u'directoryservice_activedirectory', 'ad_kerberos_realm',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['directoryservice.KerberosRealm']),
                      keep_default=False)

        # Adding field 'LDAP.ldap_kerberos_realm'
        db.add_column(u'directoryservice_ldap', 'ldap_kerberos_realm',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosRealm'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'LDAP.ldap_kerberos_keytab'
        db.add_column(u'directoryservice_ldap', 'ldap_kerberos_keytab',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosKeytab'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_kerberos_keytab'
        db.delete_column(u'directoryservice_activedirectory', 'ad_kerberos_keytab_id')

        # Deleting field 'ActiveDirectory.ad_kerberos_realm'
        db.delete_column(u'directoryservice_activedirectory', 'ad_kerberos_realm_id')

        # Deleting field 'LDAP.ldap_kerberos_realm'
        db.delete_column(u'directoryservice_ldap', 'ldap_kerberos_realm_id')

        # Deleting field 'LDAP.ldap_kerberos_keytab'
        db.delete_column(u'directoryservice_ldap', 'ldap_kerberos_keytab_id')
    ...
    models = {
        u'directoryservice.activedirectory': {
            ...
            'ad_idmap_backend': ('django.db.models.fields.CharField', [], {'default': "'ad'", 'max_length': '120'}),
            'ad_kerberos_keytab': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['directoryservice.KerberosKeytab']", 'null': 'True', 'blank': 'True'}),
            'ad_kerberos_realm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['directoryservice.KerberosRealm']"}),
        ...
        u'directoryservice.kerberosrealm': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'krb_admin_server': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
        ...
        u'directoryservice.ldap': {
            ...
            'ldap_kerberos_keytab': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['directoryservice.KerberosKeytab']", 'null': 'True', 'blank': 'True'}),
            'ldap_kerberos_realm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['directoryservice.KerberosRealm']", 'null': 'True', 'blank': 'True'}),
