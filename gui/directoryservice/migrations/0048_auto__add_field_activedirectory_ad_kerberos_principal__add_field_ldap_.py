...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_kerberos_principal'
        db.add_column(u'directoryservice_activedirectory', 'ad_kerberos_principal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosPrincipal'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'LDAP.ldap_kerberos_principal'
        db.add_column(u'directoryservice_ldap', 'ldap_kerberos_principal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosPrincipal'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_kerberos_principal'
        db.delete_column(u'directoryservice_activedirectory', 'ad_kerberos_principal_id')

        # Deleting field 'LDAP.ldap_kerberos_principal'
        db.delete_column(u'directoryservice_ldap', 'ldap_kerberos_principal_id')
