...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'directoryservice_activedirectory', 'ad_certfile_id')

        # Adding field 'ActiveDirectory.ad_certificate'
        db.add_column(u'directoryservice_activedirectory', 'ad_certificate',
        ...
        # Deleting field 'LDAP.ldap_certfile'
        db.delete_column(u'directoryservice_ldap', 'ldap_certfile_id')

        # Adding field 'LDAP.ldap_certificate'
        db.add_column(u'directoryservice_ldap', 'ldap_certificate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.CertificateAuthority'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'directoryservice_activedirectory', 'ad_certfile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['system.Certificate'], blank=True),
                      keep_default=False)

        # Deleting field 'ActiveDirectory.ad_certificate'
        db.delete_column(u'directoryservice_activedirectory', 'ad_certificate_id')

        # Adding field 'LDAP.ldap_certfile'
        db.add_column(u'directoryservice_ldap', 'ldap_certfile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['system.Certificate'], blank=True),
                      keep_default=False)

        # Deleting field 'LDAP.ldap_certificate'
        db.delete_column(u'directoryservice_ldap', 'ldap_certificate_id')
