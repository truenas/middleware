...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KerberosSettings'
        db.create_table(u'directoryservice_kerberossettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ks_appdefaults_aux', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('ks_libdefaults_aux', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'directoryservice', ['KerberosSettings'])


    def backwards(self, orm):
        # Deleting model 'KerberosSettings'
        db.delete_table(u'directoryservice_kerberossettings')
