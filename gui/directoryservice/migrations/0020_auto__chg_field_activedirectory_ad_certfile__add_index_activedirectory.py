...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ActiveDirectory.ad_certfile' to match new field type.
        db.rename_column(u'directoryservice_activedirectory', 'ad_certfile', 'ad_certfile_id')
        # Changing field 'ActiveDirectory.ad_certfile'
        db.alter_column(u'directoryservice_activedirectory', 'ad_certfile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Certificate']))
        # Adding index on 'ActiveDirectory', fields ['ad_certfile']
        db.create_index(u'directoryservice_activedirectory', ['ad_certfile_id'])


        # Renaming column for 'LDAP.ldap_certfile' to match new field type.
        db.rename_column(u'directoryservice_ldap', 'ldap_certfile', 'ldap_certfile_id')
        # Changing field 'LDAP.ldap_certfile'
        db.alter_column(u'directoryservice_ldap', 'ldap_certfile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Certificate']))
        # Adding index on 'LDAP', fields ['ldap_certfile']
        db.create_index(u'directoryservice_ldap', ['ldap_certfile_id'])


    def backwards(self, orm):
        # Removing index on 'LDAP', fields ['ldap_certfile']
        db.delete_index(u'directoryservice_ldap', ['ldap_certfile_id'])

        # Removing index on 'ActiveDirectory', fields ['ad_certfile']
        db.delete_index(u'directoryservice_activedirectory', ['ad_certfile_id'])


        # Renaming column for 'ActiveDirectory.ad_certfile' to match new field type.
        db.rename_column(u'directoryservice_activedirectory', 'ad_certfile_id', 'ad_certfile')
        # Changing field 'ActiveDirectory.ad_certfile'
        db.alter_column(u'directoryservice_activedirectory', 'ad_certfile', self.gf('django.db.models.fields.TextField')())

        # Renaming column for 'LDAP.ldap_certfile' to match new field type.
        db.rename_column(u'directoryservice_ldap', 'ldap_certfile_id', 'ldap_certfile')
        # Changing field 'LDAP.ldap_certfile'
        db.alter_column(u'directoryservice_ldap', 'ldap_certfile', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        u'directoryservice.activedirectory': {
            ...
            'ad_certfile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['system.Certificate']", 'blank': 'True'}),
        ...
        u'directoryservice.ldap': {
            ...
            'ldap_certfile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['system.Certificate']", 'blank': 'True'}),
