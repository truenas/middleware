...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ActiveDirectory.ad_netbiosname_a'
        db.delete_column(u'directoryservice_activedirectory', 'ad_netbiosname_a')


    def backwards(self, orm):
        # Adding field 'ActiveDirectory.ad_netbiosname_b'
        db.add_column(u'directoryservice_activedirectory', 'ad_netbiosname_b',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_netbiosname_a'
        db.add_column(u'directoryservice_activedirectory', 'ad_netbiosname_a',
