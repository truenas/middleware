...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'idmap_rfc2307.idmap_rfc2307_ldap_user_dn_password'
        db.add_column(u'directoryservice_idmap_rfc2307', 'idmap_rfc2307_ldap_user_dn_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'idmap_rfc2307.idmap_rfc2307_ldap_user_dn_password'
        db.delete_column(u'directoryservice_idmap_rfc2307', 'idmap_rfc2307_ldap_user_dn_password')
