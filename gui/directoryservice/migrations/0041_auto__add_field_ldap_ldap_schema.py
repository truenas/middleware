...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LDAP.ldap_schema'
        db.add_column(u'directoryservice_ldap', 'ldap_schema',
                      self.gf('django.db.models.fields.CharField')(default='rfc2307', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LDAP.ldap_schema'
        db.delete_column(u'directoryservice_ldap', 'ldap_schema')
