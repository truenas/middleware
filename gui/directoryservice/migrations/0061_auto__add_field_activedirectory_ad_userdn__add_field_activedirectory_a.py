...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_userdn'
        db.add_column(u'directoryservice_activedirectory', 'ad_userdn',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_groupdn'
        db.add_column(u'directoryservice_activedirectory', 'ad_groupdn',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_userdn'
        db.delete_column(u'directoryservice_activedirectory', 'ad_userdn')

        # Deleting field 'ActiveDirectory.ad_groupdn'
        db.delete_column(u'directoryservice_activedirectory', 'ad_groupdn')
