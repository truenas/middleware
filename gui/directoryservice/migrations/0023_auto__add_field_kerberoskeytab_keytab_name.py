...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KerberosKeytab.keytab_name'
        db.add_column(u'directoryservice_kerberoskeytab', 'keytab_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KerberosKeytab.keytab_name'
        db.delete_column(u'directoryservice_kerberoskeytab', 'keytab_name')
