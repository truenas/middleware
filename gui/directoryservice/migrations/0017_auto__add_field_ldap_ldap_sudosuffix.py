...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LDAP.ldap_sudosuffix'
        db.add_column(u'directoryservice_ldap', 'ldap_sudosuffix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LDAP.ldap_sudosuffix'
        db.delete_column(u'directoryservice_ldap', 'ldap_sudosuffix')
