...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KerberosPrincipal'
        db.create_table(u'directoryservice_kerberosprincipal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('principal_keytab', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosKeytab'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('principal_version', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('principal_encryption', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('principal_name', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('principal_timestamp', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'directoryservice', ['KerberosPrincipal'])


    def backwards(self, orm):
        # Deleting model 'KerberosPrincipal'
        db.delete_table(u'directoryservice_kerberosprincipal')
