...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LDAP.ldap_binddn'
        db.alter_column(u'directoryservice_ldap', 'ldap_binddn', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'LDAP.ldap_binddn'
        db.alter_column(u'directoryservice_ldap', 'ldap_binddn', self.gf('django.db.models.fields.CharField')(max_length=120))
