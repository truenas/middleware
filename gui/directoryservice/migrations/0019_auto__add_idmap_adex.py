...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'idmap_adex'
        db.create_table(u'directoryservice_idmap_adex', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('idmap_ds_type', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('idmap_ds_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('idmap_adex_range_low', self.gf('django.db.models.fields.IntegerField')(default=10000)),
            ('idmap_adex_range_high', self.gf('django.db.models.fields.IntegerField')(default=90000000)),
        ))
        db.send_create_signal(u'directoryservice', ['idmap_adex'])


    def backwards(self, orm):
        # Deleting model 'idmap_adex'
        db.delete_table(u'directoryservice_idmap_adex')
