...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NT4.nt4_netbiosname'
        db.delete_column(u'directoryservice_nt4', 'nt4_netbiosname')


    def backwards(self, orm):
        # Adding field 'NT4.nt4_netbiosname'
        db.add_column(u'directoryservice_nt4', 'nt4_netbiosname',
