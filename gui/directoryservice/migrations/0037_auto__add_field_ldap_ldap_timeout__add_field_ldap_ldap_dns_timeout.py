...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LDAP.ldap_timeout'
        db.add_column(u'directoryservice_ldap', 'ldap_timeout',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'LDAP.ldap_dns_timeout'
        db.add_column(u'directoryservice_ldap', 'ldap_dns_timeout',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LDAP.ldap_timeout'
        db.delete_column(u'directoryservice_ldap', 'ldap_timeout')

        # Deleting field 'LDAP.ldap_dns_timeout'
        db.delete_column(u'directoryservice_ldap', 'ldap_dns_timeout')
