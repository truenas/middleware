...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'KerberosRealm', fields ['krb_realm']
        db.create_unique(u'directoryservice_kerberosrealm', ['krb_realm'])


    def backwards(self, orm):
        # Removing unique constraint on 'KerberosRealm', fields ['krb_realm']
        db.delete_unique(u'directoryservice_kerberosrealm', ['krb_realm'])
