...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NT4.nt4_use_default_domain'
        db.add_column(u'directoryservice_nt4', 'nt4_use_default_domain',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        db.execute("update directoryservice_nt4 set nt4_use_default_domain=0")

        # Adding field 'LDAP.ldap_use_default_domain'
        db.add_column(u'directoryservice_ldap', 'ldap_use_default_domain',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        db.execute("update directoryservice_ldap set ldap_use_default_domain=0")
