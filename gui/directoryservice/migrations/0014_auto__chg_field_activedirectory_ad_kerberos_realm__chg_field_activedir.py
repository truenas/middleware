...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'directoryservice_activedirectory', 'ad_kerberos_realm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosRealm'], on_delete=models.DO_NOTHING))

        # Changing field 'ActiveDirectory.ad_kerberos_keytab'
        db.alter_column(u'directoryservice_activedirectory', 'ad_kerberos_keytab_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosKeytab'], null=True, on_delete=models.SET_NULL))

        # Changing field 'LDAP.ldap_kerberos_keytab'
        db.alter_column(u'directoryservice_ldap', 'ldap_kerberos_keytab_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosKeytab'], null=True, on_delete=models.SET_NULL))

        # Changing field 'LDAP.ldap_kerberos_realm'
        db.alter_column(u'directoryservice_ldap', 'ldap_kerberos_realm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosRealm'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'ActiveDirectory.ad_kerberos_realm'
        db.alter_column(u'directoryservice_activedirectory', 'ad_kerberos_realm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosRealm']))

        # Changing field 'ActiveDirectory.ad_kerberos_keytab'
        db.alter_column(u'directoryservice_activedirectory', 'ad_kerberos_keytab_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosKeytab'], null=True))

        # Changing field 'LDAP.ldap_kerberos_keytab'
        db.alter_column(u'directoryservice_ldap', 'ldap_kerberos_keytab_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosKeytab'], null=True))

        # Changing field 'LDAP.ldap_kerberos_realm'
        db.alter_column(u'directoryservice_ldap', 'ldap_kerberos_realm_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directoryservice.KerberosRealm'], null=True))
    ...
    models = {
        u'directoryservice.activedirectory': {
            ...
            'ad_kerberos_realm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['directoryservice.KerberosRealm']", 'on_delete': 'models.DO_NOTHING'}),
