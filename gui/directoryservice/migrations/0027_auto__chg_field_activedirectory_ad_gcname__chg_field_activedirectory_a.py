...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'directoryservice_activedirectory', 'ad_gcname', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'ActiveDirectory.ad_dcname'
        db.alter_column(u'directoryservice_activedirectory', 'ad_dcname', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'ActiveDirectory.ad_gcname'
        db.alter_column(u'directoryservice_activedirectory', 'ad_gcname', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'ActiveDirectory.ad_dcname'
        db.alter_column(u'directoryservice_activedirectory', 'ad_dcname', self.gf('django.db.models.fields.CharField')(default='', max_length=120))
