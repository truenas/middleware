...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for kt in orm.KerberosKeytab.objects.all():
            kt.keytab_name = re.sub('[^a-zA-Z0-9]+', '_', kt.keytab_principal)
            kt.save()
    ...
    models = {
        ...
        u'directoryservice.kerberoskeytab': {
            ...
            'keytab_name': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
