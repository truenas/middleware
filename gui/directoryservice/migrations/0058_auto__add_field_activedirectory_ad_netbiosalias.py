...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_netbiosalias'
        db.add_column(u'directoryservice_activedirectory', 'ad_netbiosalias',
        ...
        if not db.dry_run:
            ...
            if not ad:
                return
            ad.ad_netbiosname_a, ad.ad_netbiosalias = netbios_split(ad.ad_netbiosname_a)
            ad.save()


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_netbiosalias'
        db.delete_column(u'directoryservice_activedirectory', 'ad_netbiosalias')
