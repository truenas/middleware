...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_ldap_sasl_wrapping'
        db.add_column(u'directoryservice_activedirectory', 'ad_ldap_sasl_wrapping',
                      self.gf('django.db.models.fields.CharField')(default='plain', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_ldap_sasl_wrapping'
        db.delete_column(u'directoryservice_activedirectory', 'ad_ldap_sasl_wrapping')
