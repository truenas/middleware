...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LDAP.ldap_auxiliary_parameters'
        db.add_column(u'directoryservice_ldap', 'ldap_auxiliary_parameters',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LDAP.ldap_auxiliary_parameters'
        db.delete_column(u'directoryservice_ldap', 'ldap_auxiliary_parameters')
