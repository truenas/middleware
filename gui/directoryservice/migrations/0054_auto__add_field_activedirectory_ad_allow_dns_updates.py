...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_allow_dns_updates'
        db.add_column(u'directoryservice_activedirectory', 'ad_allow_dns_updates',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        db.execute("update directoryservice_activedirectory set ad_allow_dns_updates = '1'")


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_allow_dns_updates'
        db.delete_column(u'directoryservice_activedirectory', 'ad_allow_dns_updates')
