...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'KerberosKeytab.keytab_principal'
        db.delete_column(u'directoryservice_kerberoskeytab', 'keytab_principal')


    def backwards(self, orm):
        # Adding field 'KerberosKeytab.keytab_principal'
        db.add_column(u'directoryservice_kerberoskeytab', 'keytab_principal',
