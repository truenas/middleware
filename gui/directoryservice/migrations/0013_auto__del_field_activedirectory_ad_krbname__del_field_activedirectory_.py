...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'directoryservice_activedirectory', 'ad_krbname')

        # Deleting field 'ActiveDirectory.ad_keytab'
        db.delete_column(u'directoryservice_activedirectory', 'ad_keytab')

        # Deleting field 'ActiveDirectory.ad_kpwdname'
        db.delete_column(u'directoryservice_activedirectory', 'ad_kpwdname')


    def backwards(self, orm):
        # Adding field 'ActiveDirectory.ad_krbname'
        db.add_column(u'directoryservice_activedirectory', 'ad_krbname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_keytab'
        db.add_column(u'directoryservice_activedirectory', 'ad_keytab',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActiveDirectory.ad_kpwdname'
        db.add_column(u'directoryservice_activedirectory', 'ad_kpwdname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)
