...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LDAP.ldap_has_samba_schema'
        db.add_column(u'directoryservice_ldap', 'ldap_has_samba_schema',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LDAP.ldap_has_samba_schema'
        db.delete_column(u'directoryservice_ldap', 'ldap_has_samba_schema')
