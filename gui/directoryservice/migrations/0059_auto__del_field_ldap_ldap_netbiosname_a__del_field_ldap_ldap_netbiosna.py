...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LDAP.ldap_netbiosname_a'
        db.delete_column(u'directoryservice_ldap', 'ldap_netbiosname_a')

        # Deleting field 'LDAP.ldap_netbiosname_b'
        db.delete_column(u'directoryservice_ldap', 'ldap_netbiosname_b')


    def backwards(self, orm):
        # Adding field 'LDAP.ldap_netbiosname_a'
        db.add_column(u'directoryservice_ldap', 'ldap_netbiosname_a',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)

        # Adding field 'LDAP.ldap_netbiosname_b'
        db.add_column(u'directoryservice_ldap', 'ldap_netbiosname_b',
