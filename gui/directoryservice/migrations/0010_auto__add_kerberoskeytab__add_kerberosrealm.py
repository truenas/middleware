...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KerberosKeytab'
        db.create_table(u'directoryservice_kerberoskeytab', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keytab_principal', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('keytab_file', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'directoryservice', ['KerberosKeytab'])

        # Adding model 'KerberosRealm'
        db.create_table(u'directoryservice_kerberosrealm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('krb_realm', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('krb_kdc', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('krb_admin_server', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('krb_kpasswd_server', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal(u'directoryservice', ['KerberosRealm'])


    def backwards(self, orm):
        # Deleting model 'KerberosKeytab'
        db.delete_table(u'directoryservice_kerberoskeytab')

        # Deleting model 'KerberosRealm'
        db.delete_table(u'directoryservice_kerberosrealm')
    ...
    models = {
        ...
        u'directoryservice.kerberosrealm': {
            ...
            'krb_kpasswd_server': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
