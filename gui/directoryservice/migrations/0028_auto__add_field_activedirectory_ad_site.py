...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActiveDirectory.ad_site'
        db.add_column(u'directoryservice_activedirectory', 'ad_site',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActiveDirectory.ad_site'
        db.delete_column(u'directoryservice_activedirectory', 'ad_site')
