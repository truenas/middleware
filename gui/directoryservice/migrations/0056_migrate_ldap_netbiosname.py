...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ldap = orm.LDAP.objects.all()
        if not ldap:
            return 

        cifs = orm['services.CIFS'].objects.all()
        if not cifs:
            return 
        ...
        ldap.ldap_netbiosname_a = cifs.cifs_srv_netbiosname
        ldap.save()
    ...
    models = {
        ...
        u'services.iscsitargetextent': {
            ...
            'iscsi_target_extent_serial': ('django.db.models.fields.CharField', [], {'default': "'00505682304e00'", 'max_length': '16'}),
