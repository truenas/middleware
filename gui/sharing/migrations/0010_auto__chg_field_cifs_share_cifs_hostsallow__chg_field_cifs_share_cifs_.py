...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CIFS_Share.cifs_hostsallow'
        db.alter_column('sharing_cifs_share', 'cifs_hostsallow', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CIFS_Share.cifs_hostsdeny'
        db.alter_column('sharing_cifs_share', 'cifs_hostsdeny', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'CIFS_Share.cifs_hostsallow'
        db.alter_column('sharing_cifs_share', 'cifs_hostsallow', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'CIFS_Share.cifs_hostsdeny'
        db.alter_column('sharing_cifs_share', 'cifs_hostsdeny', self.gf('django.db.models.fields.CharField')(max_length=120))
