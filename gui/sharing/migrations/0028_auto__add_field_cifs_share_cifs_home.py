...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS_Share.cifs_home'
        db.add_column(u'sharing_cifs_share', 'cifs_home',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CIFS_Share.cifs_home'
        db.delete_column(u'sharing_cifs_share', 'cifs_home')
