...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CIFS_Share.cifs_guestok'
        db.delete_column('sharing_cifs_share', 'cifs_guestok')

        # Deleting field 'CIFS_Share.cifs_guestonly'
        db.delete_column('sharing_cifs_share', 'cifs_guestonly')
