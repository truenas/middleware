...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS_Share.cifs_storage_task'
        db.add_column(u'sharing_cifs_share', 'cifs_storage_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Task'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CIFS_Share.cifs_storage_task'
        db.delete_column(u'sharing_cifs_share', 'cifs_storage_task_id')
