...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NFS_Share.nfs_security'
        db.add_column(u'sharing_nfs_share', 'nfs_security',
                      self.gf('freenasUI.freeadmin.models.fields.MultiSelectField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NFS_Share.nfs_security'
        db.delete_column(u'sharing_nfs_share', 'nfs_security')
