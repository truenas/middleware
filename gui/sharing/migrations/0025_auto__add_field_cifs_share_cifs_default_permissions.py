...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS_Share.cifs_default_permissions'
        db.add_column(u'sharing_cifs_share', 'cifs_default_permissions',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CIFS_Share.cifs_default_permissions'
        db.delete_column(u'sharing_cifs_share', 'cifs_default_permissions')
    ...
    models = {
        ...
        u'sharing.cifs_share': {
            ...
            'cifs_inheritacls': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'sharing.nfs_share': {
            'Meta': {'ordering': "['paths__path']", 'object_name': 'NFS_Share'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
