...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NFS_Share.nfs_network'
        db.alter_column('sharing_nfs_share', 'nfs_network', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'NFS_Share.nfs_network'
        db.alter_column('sharing_nfs_share', 'nfs_network', self.gf('django.db.models.fields.CharField')(max_length=120))
