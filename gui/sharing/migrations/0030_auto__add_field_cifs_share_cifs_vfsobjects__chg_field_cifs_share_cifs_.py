...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CIFS_Share.cifs_vfsobjects'
        db.add_column(u'sharing_cifs_share', 'cifs_vfsobjects',
                      self.gf('freenasUI.freeadmin.models.fields.MultiSelectField')(default='aio_pthread,streams_xattr', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'CIFS_Share.cifs_path'
        db.alter_column(u'sharing_cifs_share', 'cifs_path', self.gf('freenasUI.freeadmin.models.fields.PathField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'CIFS_Share.cifs_vfsobjects'
        db.delete_column(u'sharing_cifs_share', 'cifs_vfsobjects')


        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CIFS_Share.cifs_path'
        db.alter_column(u'sharing_cifs_share', 'cifs_path', self.gf('freenasUI.freeadmin.models.fields.PathField')(max_length=255, default=''))
