...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AFP_Share.afp_dbpath'
        db.delete_column(u'sharing_afp_share', 'afp_dbpath')


    def backwards(self, orm):
        # Adding field 'AFP_Share.afp_dbpath'
        db.add_column(u'sharing_afp_share', 'afp_dbpath',
