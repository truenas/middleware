...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sharing_afp_share', 'afp_path', self.gf('freeadmin.models.PathField')(max_length=255))

        # Changing field 'NFS_Share.nfs_path'
        db.alter_column('sharing_nfs_share', 'nfs_path', self.gf('freeadmin.models.PathField')(max_length=255))

        # Changing field 'CIFS_Share.cifs_path'
        db.alter_column('sharing_cifs_share', 'cifs_path', self.gf('freeadmin.models.PathField')(max_length=255))
    ...
    models = {
        'sharing.afp_share': {
            ...
            'afp_path': ('freeadmin.models.PathField', [], {'max_length': '255'}),
        ...
        'sharing.cifs_share': {
            ...
            'cifs_path': ('freeadmin.models.PathField', [], {'max_length': '255'}),
        ...
        'sharing.nfs_share': {
            ...
            'nfs_path': ('freeadmin.models.PathField', [], {'max_length': '255'}),
