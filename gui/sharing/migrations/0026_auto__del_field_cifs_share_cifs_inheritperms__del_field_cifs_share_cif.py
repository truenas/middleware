...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CIFS_Share.cifs_inheritperms'
        db.delete_column(u'sharing_cifs_share', 'cifs_inheritperms')
        ...
        db.delete_column(u'sharing_cifs_share', 'cifs_inheritowner')


    def backwards(self, orm):
        # Adding field 'CIFS_Share.cifs_inheritperms'
        db.add_column(u'sharing_cifs_share', 'cifs_inheritperms',
        ...
        db.add_column(u'sharing_cifs_share', 'cifs_inheritowner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
