...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AFP_Share.afp_discoverymode'
        db.delete_column(u'sharing_afp_share', 'afp_discoverymode')


    def backwards(self, orm):
        # Adding field 'AFP_Share.afp_discoverymode'
        db.add_column(u'sharing_afp_share', 'afp_discoverymode',
