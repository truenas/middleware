...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tunable.tun_value'
        db.alter_column(u'system_tunable', 'tun_value', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Tunable.tun_value'
        db.alter_column(u'system_tunable', 'tun_value', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'system.alert': {
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1448463307'})
        },
        u'system.backup': {
