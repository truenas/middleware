...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Certificate', fields ['cert_name']
        db.create_unique(u'system_certificate', ['cert_name'])

        # Adding unique constraint on 'CertificateAuthority', fields ['cert_name']
        db.create_unique(u'system_certificateauthority', ['cert_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'CertificateAuthority', fields ['cert_name']
        db.delete_unique(u'system_certificateauthority', ['cert_name'])

        # Removing unique constraint on 'Certificate', fields ['cert_name']
        db.delete_unique(u'system_certificate', ['cert_name'])
