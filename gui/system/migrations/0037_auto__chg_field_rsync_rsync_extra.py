...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rsync.rsync_extra'
        db.alter_column('system_rsync', 'rsync_extra', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Rsync.rsync_extra'
        db.alter_column('system_rsync', 'rsync_extra', self.gf('django.db.models.fields.CharField')(max_length=120))
