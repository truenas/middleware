...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'system_upgrade', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('upd_train', self.gf('django.db.models.fields.CharField')(default='stable', max_length=200)),
            ('upd_autocheck', self.gf('django.db.models.fields.BooleanField')(default=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'system_upgrade')
