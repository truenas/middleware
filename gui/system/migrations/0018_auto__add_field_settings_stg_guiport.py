...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('system_settings', 'stg_guiport', self.gf('django.db.models.fields.CharField')(default='80', max_length=120, blank=True), keep_default=False)
    ...
    models = {
        ...
        'system.settings': {
            ...
            'stg_guiport': ('django.db.models.fields.CharField', [], {'default': "'80'", 'max_length': '120', 'blank': 'True'}),
