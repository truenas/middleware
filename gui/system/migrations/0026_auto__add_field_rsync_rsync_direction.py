...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rsync.rsync_direction'
        db.add_column('system_rsync', 'rsync_direction', self.gf('django.db.models.fields.CharField')(default='push', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rsync.rsync_direction'
        db.delete_column('system_rsync', 'rsync_direction')
