...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Advanced.adv_syslog_usedataset'
        db.delete_column(u'system_advanced', 'adv_syslog_usedataset')

        # Deleting field 'Advanced.adv_system_pool'
        db.delete_column(u'system_advanced', 'adv_system_pool')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Advanced.adv_system_pool'
        db.add_column(u'system_advanced', 'adv_system_pool',
    ...
    models = {
        ...
        u'system.systemdataset': {
            ...
            'sys_syslog_usedataset': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        u'system.tunable': {
