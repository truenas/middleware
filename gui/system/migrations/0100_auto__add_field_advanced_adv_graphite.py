...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advanced.adv_graphite'
        db.add_column(u'system_advanced', 'adv_graphite',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advanced.adv_graphite'
        db.delete_column(u'system_advanced', 'adv_graphite')
    ...
    models = {
        u'system.advanced': {
            ...
            'adv_graphite': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '120'}),
        ...
        u'system.alert': {
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1454870502'})
        },
        u'system.backup': {
