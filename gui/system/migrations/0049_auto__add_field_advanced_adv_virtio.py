...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advanced.adv_virtio'
        db.add_column('system_advanced', 'adv_virtio',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advanced.adv_virtio'
        db.delete_column('system_advanced', 'adv_virtio')
    ...
    models = {
        ...
        'system.advanced': {
            ...
            'adv_virtio': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
