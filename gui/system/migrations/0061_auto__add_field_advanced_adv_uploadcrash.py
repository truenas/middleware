...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advanced.adv_uploadcrash'
        db.add_column(u'system_advanced', 'adv_uploadcrash',
    ...
    def backwards(self, orm):
        # Deleting field 'Advanced.adv_uploadcrash'
        db.delete_column(u'system_advanced', 'adv_uploadcrash')
    ...
    models = {
        ...
        u'system.advanced': {
            ...
            'adv_uploadcrash': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'system.alert': {
        ...
        u'system.settings': {
            ...
            'stg_guihttpsport': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'stg_guiport': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
