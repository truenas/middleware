...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Alert', fields ['message_id']
        db.delete_unique(u'system_alert', ['message_id'])

        # Adding field 'Alert.node'
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Alert', fields ['node', 'message_id']
        db.delete_unique(u'system_alert', ['node', 'message_id'])

        # Deleting field 'Alert.node'
        db.delete_column(u'system_alert', 'node')

        # Adding unique constraint on 'Alert', fields ['message_id']
        db.create_unique(u'system_alert', ['message_id'])
    ...
    models = {
        ...
        u'system.alert': {
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1446045033'})
        },
        u'system.backup': {
