...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Backup'
        db.create_table(u'system_backup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bak_finished', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('bak_failed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('bak_acknowledged', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('bak_worker_pid', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('bak_started_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('bak_finished_at', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('bak_destination', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
            ('bak_status', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
        ))
        db.send_create_signal(u'system', ['Backup'])


    def backwards(self, orm):
        # Deleting model 'Backup'
        db.delete_table(u'system_backup')
