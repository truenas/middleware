...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'system_sysctl')


    def backwards(self, orm):
        # Adding model 'Sysctl'
        db.create_table(u'system_sysctl', (
            ('sysctl_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('sysctl_value', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sysctl_mib', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True)),
            ('sysctl_comment', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'system', ['Sysctl'])
