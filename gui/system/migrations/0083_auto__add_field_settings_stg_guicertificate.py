...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.stg_guicertificate'
        db.add_column(u'system_settings', 'stg_guicertificate',
    ...
    def backwards(self, orm):
        # Deleting field 'Settings.stg_guicertificate'
        db.delete_column(u'system_settings', 'stg_guicertificate_id')
