...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certificate.cert_signedby'
        db.alter_column(u'system_certificate', 'cert_signedby_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.CertificateAuthority'], null=True))

    def backwards(self, orm):

        # Changing field 'Certificate.cert_signedby'
        db.alter_column(u'system_certificate', 'cert_signedby_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Certificate'], null=True))
