...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Force a value or sqlite3 backend will fail to convert
        for obj in orm['system.Settings'].objects.all():
            try:
                int(obj.stg_guiport)
            except:
                obj.stg_guiport = '80'
        ...
        orm['system.Settings'].objects.filter(stg_guiport=80).update(
            stg_guiport=None,
        )
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Settings.stg_guiport'
        db.alter_column(u'system_settings', 'stg_guiport', self.gf('django.db.models.fields.CharField')(max_length=120))
