...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Alert'
        db.create_table('system_alert', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('dismiss', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('system', ['Alert'])


    def backwards(self, orm):
        # Deleting model 'Alert'
        db.delete_table('system_alert')
