...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certificate.cert_type'
        db.alter_column(u'system_certificate', 'cert_type', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CertificateAuthority.cert_type'
        db.alter_column(u'system_certificateauthority', 'cert_type', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Certificate.cert_type'
        db.alter_column(u'system_certificate', 'cert_type', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'CertificateAuthority.cert_type'
        db.alter_column(u'system_certificateauthority', 'cert_type', self.gf('django.db.models.fields.CharField')(max_length=120))
