...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for o in orm['system.Settings'].objects.all():
            if not o.stg_guihttpsport:
                o.stg_guihttpsport = 443
            if not o.stg_guiport:
                o.stg_guiport = 80
            o.save()

        # Changing field 'Settings.stg_guihttpsport'
        db.alter_column(u'system_settings', 'stg_guihttpsport', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Settings.stg_guiport'
        db.alter_column(u'system_settings', 'stg_guiport', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Settings.stg_guihttpsport'
        db.alter_column(u'system_settings', 'stg_guihttpsport', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Settings.stg_guiport'
        db.alter_column(u'system_settings', 'stg_guiport', self.gf('django.db.models.fields.IntegerField')(null=True))
