...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Registration.reg_cellphone'
        db.alter_column(u'system_registration', 'reg_cellphone', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))
        ...
        # Changing field 'Registration.reg_homephone'
        db.alter_column(u'system_registration', 'reg_homephone', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'Registration.reg_workphone'
        db.alter_column(u'system_registration', 'reg_workphone', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'Registration.reg_cellphone'
        db.alter_column(u'system_registration', 'reg_cellphone', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'Registration.reg_email'
        db.alter_column(u'system_registration', 'reg_email', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'Registration.reg_homephone'
        db.alter_column(u'system_registration', 'reg_homephone', self.gf('django.db.models.fields.CharField')(default='', max_length=120))

        # Changing field 'Registration.reg_workphone'
        db.alter_column(u'system_registration', 'reg_workphone', self.gf('django.db.models.fields.CharField')(default='', max_length=120))
    ...
    models = {
        ...
        u'system.registration': {
            ...
            'reg_email': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
