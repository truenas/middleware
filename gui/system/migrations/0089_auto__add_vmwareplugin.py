...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VMWarePlugin'
        db.create_table(u'system_vmwareplugin', (
            ...
            ('filesystem', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('datastore', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'system', ['VMWarePlugin'])


    def backwards(self, orm):
        # Deleting model 'VMWarePlugin'
        db.delete_table(u'system_vmwareplugin')
