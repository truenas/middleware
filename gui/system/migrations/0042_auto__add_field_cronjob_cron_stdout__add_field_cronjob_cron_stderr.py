...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CronJob.cron_stdout'
        db.add_column('system_cronjob', 'cron_stdout', self.gf('django.db.models.fields.BooleanField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CronJob.cron_stdout'
        db.delete_column('system_cronjob', 'cron_stdout')

        # Deleting field 'CronJob.cron_stderr'
        db.delete_column('system_cronjob', 'cron_stderr')
