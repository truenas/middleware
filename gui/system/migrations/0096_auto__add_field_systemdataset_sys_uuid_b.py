...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SystemDataset.sys_uuid_b'
        db.add_column(u'system_systemdataset', 'sys_uuid_b',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SystemDataset.sys_uuid_b'
        db.delete_column(u'system_systemdataset', 'sys_uuid_b')
