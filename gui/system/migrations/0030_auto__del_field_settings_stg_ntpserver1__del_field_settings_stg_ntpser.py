...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('system_settings', 'stg_ntpserver1', self.gf('django.db.models.fields.CharField')(default='0.freebsd.pool.ntp.org iburst maxpoll 9', max_length=120), keep_default=False)

        # Adding field 'Settings.stg_ntpserver2'
        db.add_column('system_settings', 'stg_ntpserver2', self.gf('django.db.models.fields.CharField')(default='1.freebsd.pool.ntp.org iburst maxpoll 9', max_length=120, blank=True), keep_default=False)

        # Adding field 'Settings.stg_ntpserver3'
        db.add_column('system_settings', 'stg_ntpserver3', self.gf('django.db.models.fields.CharField')(default='2.freebsd.pool.ntp.org iburst maxpoll 9', max_length=120, blank=True), keep_default=False)
