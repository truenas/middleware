...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Upgrade.upd_train'
        db.delete_column(u'system_upgrade', 'upd_train')

        # Deleting field 'Upgrade.upd_location'
        db.delete_column(u'system_upgrade', 'upd_location')


    def backwards(self, orm):
        # Adding field 'Upgrade.upd_train'
        db.add_column(u'system_upgrade', 'upd_train',
                      self.gf('django.db.models.fields.CharField')(default='stable', max_length=200),
                      keep_default=False)

        # Adding field 'Upgrade.upd_location'
        db.add_column(u'system_upgrade', 'upd_location',
                      self.gf('django.db.models.fields.URLField')(default='http://download.freenas.org/FreeNAS/', max_length=200),
                      keep_default=False)
