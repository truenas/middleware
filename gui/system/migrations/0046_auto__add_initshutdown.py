...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InitShutdown'
        db.create_table('system_initshutdown', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ini_type', self.gf('django.db.models.fields.CharField')(default='command', max_length=15)),
            ('ini_command', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
            ('ini_script', self.gf('freenasUI.freeadmin.models.PathField')(max_length=255, null=True, blank=True)),
            ('ini_when', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal('system', ['InitShutdown'])


    def backwards(self, orm):
        # Deleting model 'InitShutdown'
        db.delete_table('system_initshutdown')
