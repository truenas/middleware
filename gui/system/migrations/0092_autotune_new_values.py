...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for obj in orm['system.Sysctl'].objects.filter(sysctl_comment__contains='Generated by autotune'):
            if obj.sysctl_mib == 'vfs.zfs.l2arc_headroom':
                obj.sysctl_value = '2'
                obj.save()
            elif obj.sysctl_mib == 'vfs.zfs.l2arc_write_max':
                obj.sysctl_value = '10000000'
                obj.save()
            elif obj.sysctl_mib == 'vfs.zfs.l2arc_write_boost':
                obj.sysctl_value = '40000000'
                obj.save()
