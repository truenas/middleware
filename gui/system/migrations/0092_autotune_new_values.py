...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for obj in orm['system.Tunable'].objects.filter(tun_comment__contains='Generated by autotune'):
            if obj.tun_var == 'vfs.zfs.l2arc_headroom':
                obj.tun_value = '2'
                obj.save()
            elif obj.tun_var == 'vfs.zfs.l2arc_write_max':
                obj.tun_value = '10000000'
                obj.save()
            elif obj.tun_var == 'vfs.zfs.l2arc_write_boost':
                obj.tun_value = '40000000'
                obj.save()
