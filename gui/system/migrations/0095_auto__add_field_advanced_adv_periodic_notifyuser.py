...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advanced.adv_periodic_notifyuser'
        db.add_column(u'system_advanced', 'adv_periodic_notifyuser',
                      self.gf('freenasUI.freeadmin.models.fields.UserField')(default='root', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advanced.adv_periodic_notifyuser'
        db.delete_column(u'system_advanced', 'adv_periodic_notifyuser')
