...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advanced.adv_serialspeed'
        db.add_column('system_advanced', 'adv_serialspeed',
                      self.gf('django.db.models.fields.CharField')(default='9600', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advanced.adv_serialspeed'
        db.delete_column('system_advanced', 'adv_serialspeed')
