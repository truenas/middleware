...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'system_certificate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cert_type', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('cert_name', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('cert_certificate', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cert_privatekey', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cert_key_length', self.gf('django.db.models.fields.IntegerField')(default=2048, null=True, blank=True)),
            ('cert_digest_algorithm', self.gf('django.db.models.fields.CharField')(default='SHA256', max_length=120, null=True, blank=True)),
            ('cert_lifetime', self.gf('django.db.models.fields.IntegerField')(default=3650, null=True, blank=True)),
            ('cert_country', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('cert_state', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('cert_city', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('cert_organization', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('cert_email', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('cert_common', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('cert_signedby', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.Certificate'], null=True, blank=True)),
        ))
        db.send_create_signal(u'system', ['Certificate'])

        # Adding model 'CertificateAuthority'
        db.create_table(u'system_certificateauthority', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cert_type', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('cert_name', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('cert_certificate', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('cert_email', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('cert_common', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('cert_signedby', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.CertificateAuthority'], null=True, blank=True)),
        ))
        db.send_create_signal(u'system', ['CertificateAuthority'])


    def backwards(self, orm):
        # Deleting model 'Certificate'
        db.delete_table(u'system_certificate')

        # Deleting model 'CertificateAuthority'
        db.delete_table(u'system_certificateauthority')
    ...
    models = {
        ...
        u'system.certificate': {
            ...
            'cert_signedby': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['system.Certificate']", 'null': 'True', 'blank': 'True'}),
            'cert_state': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'cert_type': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
