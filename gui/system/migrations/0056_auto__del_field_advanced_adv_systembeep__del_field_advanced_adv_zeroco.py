...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Advanced.adv_systembeep'
        db.delete_column(u'system_advanced', 'adv_systembeep')

        # Deleting field 'Advanced.adv_zeroconfbonjour'
        db.delete_column(u'system_advanced', 'adv_zeroconfbonjour')

        # Deleting field 'Advanced.adv_tuning'
        db.delete_column(u'system_advanced', 'adv_tuning')

        # Deleting field 'Advanced.adv_firmwarevc'
        db.delete_column(u'system_advanced', 'adv_firmwarevc')


    def backwards(self, orm):
        # Adding field 'Advanced.adv_systembeep'
        db.add_column(u'system_advanced', 'adv_systembeep',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Advanced.adv_zeroconfbonjour'
        db.add_column(u'system_advanced', 'adv_zeroconfbonjour',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Advanced.adv_tuning'
        db.add_column(u'system_advanced', 'adv_tuning',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Advanced.adv_firmwarevc'
        db.add_column(u'system_advanced', 'adv_firmwarevc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
