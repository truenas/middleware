...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advanced.adv_serialport'
        db.add_column(u'system_advanced', 'adv_serialport',
                      self.gf('django.db.models.fields.CharField')(default='0x2f8', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advanced.adv_serialport'
        db.delete_column(u'system_advanced', 'adv_serialport')
