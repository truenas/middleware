...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('system_settings', 'stg_guiport', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Settings.stg_guiport'
        db.alter_column('system_settings', 'stg_guiport', self.gf('django.db.models.fields.CharField')(max_length=120))
    ...
    models = {
        ...
        'system.settings': {
            ...
            'stg_guiport': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
