...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.cert_serial'
        db.add_column(u'system_certificate', 'cert_serial',
                      self.gf('django.db.models.fields.IntegerField')(max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CertificateAuthority.cert_serial'
        db.add_column(u'system_certificateauthority', 'cert_serial',
                      self.gf('django.db.models.fields.IntegerField')(max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Certificate.cert_serial'
        db.delete_column(u'system_certificate', 'cert_serial')

        # Deleting field 'CertificateAuthority.cert_serial'
        db.delete_column(u'system_certificateauthority', 'cert_serial')
