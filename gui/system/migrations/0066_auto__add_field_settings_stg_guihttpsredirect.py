...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Settings.stg_guihttpsredirect'
        db.delete_column(u'system_settings', 'stg_guihttpsredirect')
    ...
    models = {
        ...
        u'system.advanced': {
            ...
            'adv_syslog_usedataset': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
