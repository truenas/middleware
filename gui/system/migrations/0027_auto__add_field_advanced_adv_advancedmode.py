...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advanced.adv_advancedmode'
        db.add_column('system_advanced', 'adv_advancedmode', self.gf('django.db.models.fields.BooleanField')(default=0), keep_default=False)

        # Workaround south bug
        orm['system.Advanced'].objects.update(adv_advancedmode=False)


    def backwards(self, orm):
        
        # Deleting field 'Advanced.adv_advancedmode'
        db.delete_column('system_advanced', 'adv_advancedmode')
