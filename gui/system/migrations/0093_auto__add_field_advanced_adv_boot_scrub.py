...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advanced.adv_boot_scrub'
        db.add_column(u'system_advanced', 'adv_boot_scrub',
                      self.gf('django.db.models.fields.IntegerField')(default=35),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advanced.adv_boot_scrub'
        db.delete_column(u'system_advanced', 'adv_boot_scrub')
