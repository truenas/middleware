...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SystemDataset'
        db.create_table(u'system_systemdataset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sys_pool', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
            ('sys_syslog_usedataset', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('sys_rrd_usedataset', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'system', ['SystemDataset'])


    def backwards(self, orm):
        # Deleting model 'SystemDataset'
        db.delete_table(u'system_systemdataset')
