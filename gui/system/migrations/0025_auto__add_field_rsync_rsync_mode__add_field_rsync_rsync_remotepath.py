...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rsync.rsync_mode'
        db.add_column('system_rsync', 'rsync_mode', self.gf('django.db.models.fields.CharField')(default='module', max_length=20), keep_default=False)

        # Adding field 'Rsync.rsync_remotepath'
        db.add_column('system_rsync', 'rsync_remotepath', self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rsync.rsync_mode'
        db.delete_column('system_rsync', 'rsync_mode')

        # Deleting field 'Rsync.rsync_remotepath'
        db.delete_column('system_rsync', 'rsync_remotepath')
