...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CronJob.cron_description'
        ...
        orm['system.CronJob'].objects.update(cron_enabled=True)


    def backwards(self, orm):
        
        # Deleting field 'CronJob.cron_description'
        db.delete_column('system_cronjob', 'cron_description')

        # Deleting field 'CronJob.cron_enabled'
        db.delete_column('system_cronjob', 'cron_enabled')
    ...
    models = {
        ...
        'system.settings': {
            ...
            'stg_syslogserver': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
