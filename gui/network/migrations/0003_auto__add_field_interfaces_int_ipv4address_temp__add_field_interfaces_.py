...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interfaces.int_v4netmaskbit'
        db.add_column('network_interfaces', 'int_v4netmaskbit', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Interfaces.int_v6netmaskbit'
        db.add_column('network_interfaces', 'int_v6netmaskbit', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Interfaces.int_v4netmaskbit'
        db.delete_column('network_interfaces', 'int_v4netmaskbit')

        # Deleting field 'Interfaces.int_ipv6address_temp'
        db.delete_column('network_interfaces', 'int_ipv6address_temp')

        # Deleting field 'Interfaces.int_v6netmaskbit'
        db.delete_column('network_interfaces', 'int_v6netmaskbit')

        # Changing field 'GlobalConfiguration.gc_ipv4gateway'
        db.alter_column('network_globalconfiguration', 'gc_ipv4gateway', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'GlobalConfiguration.gc_ipv6gateway'
        db.alter_column('network_globalconfiguration', 'gc_ipv6gateway', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'GlobalConfiguration.gc_nameserver1'
        db.alter_column('network_globalconfiguration', 'gc_nameserver1', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'GlobalConfiguration.gc_nameserver3'
        db.alter_column('network_globalconfiguration', 'gc_nameserver3', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'GlobalConfiguration.gc_nameserver2'
        db.alter_column('network_globalconfiguration', 'gc_nameserver2', self.gf('django.db.models.fields.CharField')(max_length=120))
