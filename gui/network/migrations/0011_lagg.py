...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for nics in orm.Interfaces.objects.all():
            for laggnic in orm.LAGGInterfaceMembers.objects.filter(lagg_physnic=nics.int_interface):
                if nics.int_options:
                    laggnic.lagg_deviceoptions = nics.int_options
                    laggnic.save()
                nics.delete()
