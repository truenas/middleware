...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfiguration.gc_httpproxy'
        db.add_column(u'network_globalconfiguration', 'gc_httpproxy',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfiguration.gc_httpproxy'
        db.delete_column(u'network_globalconfiguration', 'gc_httpproxy')
