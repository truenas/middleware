...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interfaces.int_group'
        db.add_column(u'network_interfaces', 'int_group',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Interfaces.int_group'
        db.delete_column(u'network_interfaces', 'int_group')
