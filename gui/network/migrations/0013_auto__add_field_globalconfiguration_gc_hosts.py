...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfiguration.gc_hosts'
        db.add_column('network_globalconfiguration', 'gc_hosts',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfiguration.gc_hosts'
        db.delete_column('network_globalconfiguration', 'gc_hosts')
