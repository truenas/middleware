...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'JailTemplate', fields ['jt_name']
        db.create_unique(u'jails_jailtemplate', ['jt_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'JailTemplate', fields ['jt_name']
        db.delete_unique(u'jails_jailtemplate', ['jt_name'])
