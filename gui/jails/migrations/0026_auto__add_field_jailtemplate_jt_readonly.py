...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JailTemplate.jt_readonly'
        db.add_column(u'jails_jailtemplate', 'jt_readonly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        db.execute("update jails_jailtemplate set jt_readonly = '0'")


    def backwards(self, orm):
        # Deleting field 'JailTemplate.jt_readonly'
        db.delete_column(u'jails_jailtemplate', 'jt_readonly')
