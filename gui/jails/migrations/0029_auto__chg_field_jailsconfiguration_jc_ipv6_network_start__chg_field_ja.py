...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv6_network_start', self.gf('freenasUI.freeadmin.models.fields.Network6Field')(max_length=43, null=True))

        # Changing field 'JailsConfiguration.jc_ipv6_network'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv6_network', self.gf('freenasUI.freeadmin.models.fields.Network6Field')(max_length=43, null=True))

        # Changing field 'JailsConfiguration.jc_ipv6_network_end'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv6_network_end', self.gf('freenasUI.freeadmin.models.fields.Network6Field')(max_length=43, null=True))

        # Changing field 'JailsConfiguration.jc_ipv4_network'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv4_network', self.gf('freenasUI.freeadmin.models.fields.Network4Field')(max_length=18, null=True))

        # Changing field 'JailsConfiguration.jc_ipv4_network_start'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv4_network_start', self.gf('freenasUI.freeadmin.models.fields.Network4Field')(max_length=18, null=True))

        # Changing field 'JailsConfiguration.jc_ipv4_network_end'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv4_network_end', self.gf('freenasUI.freeadmin.models.fields.Network4Field')(max_length=18, null=True))

    def backwards(self, orm):

        # Changing field 'JailsConfiguration.jc_ipv6_network_start'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv6_network_start', self.gf('freenasUI.freeadmin.models.fields.Network6Field')(default='', max_length=43))

        # Changing field 'JailsConfiguration.jc_ipv6_network'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv6_network', self.gf('freenasUI.freeadmin.models.fields.Network6Field')(default='', max_length=43))

        # Changing field 'JailsConfiguration.jc_ipv6_network_end'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv6_network_end', self.gf('freenasUI.freeadmin.models.fields.Network6Field')(default='', max_length=43))

        # Changing field 'JailsConfiguration.jc_ipv4_network'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv4_network', self.gf('freenasUI.freeadmin.models.fields.Network4Field')(default='', max_length=18))

        # Changing field 'JailsConfiguration.jc_ipv4_network_start'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv4_network_start', self.gf('freenasUI.freeadmin.models.fields.Network4Field')(default='', max_length=18))

        # Changing field 'JailsConfiguration.jc_ipv4_network_end'
        db.alter_column(u'jails_jailsconfiguration', 'jc_ipv4_network_end', self.gf('freenasUI.freeadmin.models.fields.Network4Field')(default='', max_length=18))
