...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JailTemplate.jt_system'
        db.add_column(u'jails_jailtemplate', 'jt_system',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JailTemplate.jt_system'
        db.delete_column(u'jails_jailtemplate', 'jt_system')
