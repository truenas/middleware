...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JailTemplate.jt_mtree'
        db.add_column(u'jails_jailtemplate', 'jt_mtree',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JailTemplate.jt_mtree'
        db.delete_column(u'jails_jailtemplate', 'jt_mtree')
