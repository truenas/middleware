...
def add_jail_templates(apps, schema_editor):
    ...
    for jt in JailTemplate.objects.all():
        if is_standard_x86(jt.jt_arch) and is_freenas_url(jt.jt_url) and is_freebsd(jt.jt_os):
            try:
        ...
        elif is_standard_x64(jt.jt_arch) and is_freenas_url(jt.jt_url) and is_freebsd(jt.jt_os):
            try:
        ...
        elif is_pluginjail_x86(jt.jt_arch) and is_freenas_url(jt.jt_url) and is_freebsd(jt.jt_os):
            try:
        ...
        elif is_pluginjail_x64(jt.jt_arch) and is_freenas_url(jt.jt_url) and is_freebsd(jt.jt_os):
            try:
