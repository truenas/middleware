...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rsync.rsync_remotepath'
        db.alter_column(u'tasks_rsync', 'rsync_remotepath', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Rsync.rsync_remotepath'
        db.alter_column(u'tasks_rsync', 'rsync_remotepath', self.gf('django.db.models.fields.CharField')(max_length=120))
