...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rsync.rsync_delayupdates'
        db.add_column(u'tasks_rsync', 'rsync_delayupdates',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rsync.rsync_delayupdates'
        db.delete_column(u'tasks_rsync', 'rsync_delayupdates')
