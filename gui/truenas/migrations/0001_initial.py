...
class Migration(DataMigration):
    ...
    depends_on = (
        ('storage', '0040_auto__chg_field_encrypteddisk_encrypted_disk'),
    )
    ...
    def forwards(self, orm):
        ...
        try:
            # Adding field 'Disk.disk_enclosure_slot'
            db.add_column(u'storage_disk', 'disk_enclosure_slot',
