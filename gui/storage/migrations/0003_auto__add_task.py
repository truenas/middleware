...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Task'
        db.create_table('storage_task', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task_mountpoint', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.MountPoint'])),
            ('task_recursive', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('task_ret_unit', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('task_ret_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('task_begin', self.gf('django.db.models.fields.DateTimeField')()),
            ('task_end', self.gf('django.db.models.fields.DateTimeField')()),
            ('task_interval', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=120)),
            ('task_byweekday', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('task_bymonth', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('task_bymonthday', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal('storage', ['Task'])


    def backwards(self, orm):
        
        # Deleting model 'Task'
        db.delete_table('storage_task')
    ...
    models = {
        ...
        'storage.task': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'task_begin': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'task_end': ('django.db.models.fields.DateTimeField', [], {}),
