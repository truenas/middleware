...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Disk.disk_subsystem'
        db.add_column(u'storage_disk', 'disk_subsystem',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'Disk.disk_number'
        db.add_column(u'storage_disk', 'disk_number',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Disk.disk_subsystem'
        db.delete_column(u'storage_disk', 'disk_subsystem')

        # Deleting field 'Disk.disk_number'
        db.delete_column(u'storage_disk', 'disk_number')
