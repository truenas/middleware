...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('system', '0089_auto__add_vmwareplugin'),
    )

    def forwards(self, orm):
        db.rename_table(u'system_vmwareplugin', u'storage_vmwareplugin')

    def backwards(self, orm):
        db.rename_table(u'storage_vmwareplugin', u'system_vmwareplugin')
