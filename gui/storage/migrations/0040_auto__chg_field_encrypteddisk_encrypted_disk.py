...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EncryptedDisk.encrypted_disk'
        db.alter_column(u'storage_encrypteddisk', 'encrypted_disk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Disk'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'EncryptedDisk.encrypted_disk'
        db.alter_column(u'storage_encrypteddisk', 'encrypted_disk_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['storage.Disk']))
