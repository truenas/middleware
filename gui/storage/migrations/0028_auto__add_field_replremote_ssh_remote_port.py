...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReplRemote.ssh_remote_port'
        db.add_column('storage_replremote', 'ssh_remote_port', self.gf('django.db.models.fields.IntegerField')(default=22), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReplRemote.ssh_remote_port'
        db.delete_column('storage_replremote', 'ssh_remote_port')
