...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('storage_replication', 'repl_active',
    ...
    models = {
        ...
        'storage.replication': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
 	    'repl_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'storage.task': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
	    'task_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
