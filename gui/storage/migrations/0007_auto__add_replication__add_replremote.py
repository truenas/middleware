...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Replication'
        db.create_table('storage_replication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('repl_lastsnapshot', self.gf('django.db.models.fields.CharField')(max_length=120, blank=True)),
            ('repl_remote', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.ReplRemote'])),
            ('repl_mountpoint', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.MountPoint'])),
            ('repl_zfs', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal('storage', ['Replication'])

        # Adding model 'ReplRemote'
        db.create_table('storage_replremote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ssh_remote_hostname', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('ssh_remote_hostkey', self.gf('django.db.models.fields.CharField')(max_length=2048)),
        ))
        db.send_create_signal('storage', ['ReplRemote'])


    def backwards(self, orm):
        
        # Deleting model 'Replication'
        db.delete_table('storage_replication')

        # Deleting model 'ReplRemote'
        db.delete_table('storage_replremote')
