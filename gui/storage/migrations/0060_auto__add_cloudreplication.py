...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CloudReplication'
        db.create_table(u'storage_cloudreplication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('filesystem', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ...
        db.send_create_signal(u'storage', ['CloudReplication'])


    def backwards(self, orm):
        # Deleting model 'CloudReplication'
        db.delete_table(u'storage_cloudreplication')


    models = {
        u'storage.cloudreplication': {
            'Meta': {'ordering': "['filesystem']", 'object_name': 'CloudReplication'},
            ...
            'filesystem': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
