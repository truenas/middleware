...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Disk.disk_serial'
        db.add_column('storage_disk', 'disk_serial', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Disk.disk_serial'
        db.delete_column('storage_disk', 'disk_serial')
