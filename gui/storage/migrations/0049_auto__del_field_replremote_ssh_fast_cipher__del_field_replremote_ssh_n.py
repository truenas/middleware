...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReplRemote.ssh_fast_cipher'
        db.delete_column(u'storage_replremote', 'ssh_fast_cipher')

        # Deleting field 'ReplRemote.ssh_no_cipher'
        db.delete_column(u'storage_replremote', 'ssh_no_cipher')


    def backwards(self, orm):
        # Adding field 'ReplRemote.ssh_fast_cipher'
        db.add_column(u'storage_replremote', 'ssh_fast_cipher',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ReplRemote.ssh_no_cipher'
        db.add_column(u'storage_replremote', 'ssh_no_cipher',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
