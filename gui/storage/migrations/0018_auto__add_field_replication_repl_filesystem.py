...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Replication.repl_filesystem'
        db.add_column('storage_replication', 'repl_filesystem', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        for repl in orm.Replication.objects.all():
            fs = repl.repl_mountpoint.mp_path[5:]
            repl.repl_filesystem = fs
            repl.save()

    def backwards(self, orm):
        
        # Deleting field 'Replication.repl_filesystem'
        db.delete_column('storage_replication', 'repl_filesystem')
