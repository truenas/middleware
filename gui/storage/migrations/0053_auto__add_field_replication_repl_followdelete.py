...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Replication.repl_followdelete'
        db.add_column(u'storage_replication', 'repl_followdelete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Replication.repl_followdelete'
        db.delete_column(u'storage_replication', 'repl_followdelete')
