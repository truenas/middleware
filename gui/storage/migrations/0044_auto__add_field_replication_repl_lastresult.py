...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Replication.repl_lastresult'
        db.add_column(u'storage_replication', 'repl_lastresult',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Replication.repl_lastresult'
        db.delete_column(u'storage_replication', 'repl_lastresult')
    ...
    models = {
        ...
        u'storage.replication': {
            ...
            'repl_lastresult': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
