...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Scrub'
        db.create_table('storage_scrub', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('scrub_volume', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['storage.Volume'], unique=True)),
            ('scrub_threshold', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=35)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Scrub'
        db.delete_table('storage_scrub')
