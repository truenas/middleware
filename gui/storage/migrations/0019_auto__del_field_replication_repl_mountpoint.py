...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Replication.repl_mountpoint'
        db.delete_column('storage_replication', 'repl_mountpoint_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Replication.repl_mountpoint'
        raise RuntimeError("Cannot reverse this migration. 'Replication.repl_mountpoint' and its values cannot be restored.")
