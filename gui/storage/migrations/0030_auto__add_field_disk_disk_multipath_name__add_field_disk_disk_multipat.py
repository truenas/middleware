...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Disk.disk_multipath_name'
        db.add_column('storage_disk', 'disk_multipath_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'Disk.disk_multipath_member'
        db.add_column('storage_disk', 'disk_multipath_member', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Disk.disk_multipath_name'
        db.delete_column('storage_disk', 'disk_multipath_name')

        # Deleting field 'Disk.disk_multipath_member'
        db.delete_column('storage_disk', 'disk_multipath_member')
