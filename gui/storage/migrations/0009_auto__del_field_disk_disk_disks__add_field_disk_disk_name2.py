...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Disk.disk_name2'
        db.add_column('storage_disk', 'disk_name2', self.gf('django.db.models.fields.CharField')(default='', max_length=120), keep_default=False)

        for d in orm.Disk.objects.all():
            d.disk_name2 = d.disk_name
            d.save()


    def backwards(self, orm):
        
        # We cannot add back in field 'Disk.disk_disks'
        raise RuntimeError(
            "Cannot reverse this migration. 'Disk.disk_disks' and its values cannot be restored.")

        # Deleting field 'Disk.disk_name2'
        db.delete_column('storage_disk', 'disk_name2')
    ...
    models = {
        'storage.disk': {
            ...
            'disk_name2': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
