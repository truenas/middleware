...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('storage_replremote', 'ssh_remote_dedicateduser_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=0),
                      keep_default=False)

        # Adding field 'ReplRemote.ssh_remote_dedicateduser'
        db.add_column('storage_replremote', 'ssh_remote_dedicateduser',
