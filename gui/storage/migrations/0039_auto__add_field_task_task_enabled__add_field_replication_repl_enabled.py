...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'storage_task', 'task_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Replication.repl_enabled'
    ...
    def backwards(self, orm):
        # Deleting field 'Task.task_enabled'
        db.delete_column(u'storage_task', 'task_enabled')

        # Deleting field 'Replication.repl_enabled'
        db.delete_column(u'storage_replication', 'repl_enabled')
