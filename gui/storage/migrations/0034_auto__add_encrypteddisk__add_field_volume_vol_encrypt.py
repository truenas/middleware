...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('storage_encrypteddisk', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('encrypted_volume', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Volume'])),
            ('encrypted_disk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Disk'])),
            ('encrypted_provider', self.gf('django.db.models.fields.CharField')(unique=True, max_length=120)),
        ))
        db.send_create_signal('storage', ['EncryptedDisk'])

        # Adding field 'Volume.vol_encrypt'
        db.add_column('storage_volume', 'vol_encrypt',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('storage_encrypteddisk')

        # Deleting field 'Volume.vol_encrypt'
        db.delete_column('storage_volume', 'vol_encrypt')
